# Cluster Reference: Credit Assignment Boundary and Observability

**Overview:** Defines the boundary where credit assignment over compositional strategy graphs transitions from computationally tractable to intractable, necessitating observability-by-design.

---

## Canonical Source Segments

### Source: `disc-credit-assignment-boundary.md`
