# Cluster Reference: Composition Under Goal Divergence

**Overview:** Analyzes the failure modes of composite agency when sub-agent objectives diverge, proving that modular safety architectures fail under goal divergence unless stabilized by specific potential/monotone game dynamics.

---

## Canonical Source Segments

### Source: `der-class-coercion-in-composition.md`
...
### Source: `deriv-strategic-composition.md`
