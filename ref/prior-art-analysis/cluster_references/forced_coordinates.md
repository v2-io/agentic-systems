# Cluster Reference: Coordinate Forcing via Uniqueness Theorems

**Overview:** AAT's meta-methodological stance: eliminating arbitrary hyperparameter choices by forcing the agent's fundamental coordinates (KL divergence, Fisher metric) using classical uniqueness theorems.

---

## Canonical Source Segments

### Source: `disc-additive-coordinate-forcing.md`
