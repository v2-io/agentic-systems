# Cluster Reference: Self-Actuators Grounding and Anti-Wireheading

**Overview:** Proves a formal No-Go theorem showing that agents cannot ground their own objective revisions within their objective machinery, forcing grounding onto the non-objective adaptive substrate.

---

## Canonical Source Segments

### Source: `deriv-self-actuation-grounding.md`
