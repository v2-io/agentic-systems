---
slug: der-change-proximity-principle
type: derived
status: conditional
depends:
  - def-change-distance
...
- Domain boundaries that contain related changes ( #hyp-conceptual-alignment)
