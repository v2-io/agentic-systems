---
slug: emp-changeset-size-principle
type: empirical
status: empirical
depends:
...
where $\lvert\text{changeset}\rvert$ measures lines changed, files touched, or modules affected (see #def-atomic-changeset), excluding generated code.
...
- *Domain-aligned module boundaries* ( #hyp-conceptual-alignment): features map to single modules rather than scattering across many
