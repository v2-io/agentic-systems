...
- This segment was written by an earlier agent with less context (noted in WORKBENCH). Needs a review pass during Section I/IV tightening — particularly to connect to the AAD communication framework ( #hyp-communication-gain) and to make the information-theoretic derivation more explicit.
