...
3. **Component-level outlines, in the order the top OUTLINE references them**: `01-aat-core/OUTLINE.md`, then `02-tst-core/OUTLINE.md`, then `03-logogenic-agents/OUTLINE.md`, then `04-eli/OUTLINE.md` (or whatever the current top OUTLINE prescribes). Read them in order; the dependency direction usually flows that way too.
