...
Long-lived naming principles for the Agentic Systems Framework. Vocabulary commitments, slug discipline, evaluation criteria, decision categories, naming layers. Tactical voting mechanics (round structure, vote-weight scales, deliverable formats, cold-start discipline) were retired with the 2026-08-22 packing of the naming-cycle tree into [`.archive/msc-naming-2026-08-22.tar.gz`](../../../.archive/msc-naming-2026-08-22.tar.gz) (inner `msc/naming/naming-principles-old.md`). Unpack at the repo root to resume a voting round.
