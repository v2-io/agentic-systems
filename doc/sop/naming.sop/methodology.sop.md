...
The tracker is a compact single-table view of your card, generated by `bin/naming-master-tracker --card=<your-card-path>`. It's about 1/13th the size of the full card and lets you scan all 629 targets at once. Default output goes to `msc/naming/round-2-trackers/<seed>-tracker.md` after unpacking the naming-cycle tree from [`.archive/msc-naming-2026-08-22.tar.gz`](../../../.archive/msc-naming-2026-08-22.tar.gz).
