...
> 4. Treat logogenic agents as a sequel with a coupled update law from the start, exactly as the logogenic outline says `03-llm-core/OUTLINE.md:9`. Do not try to smuggle LLM agents back into the modular case by approximation rhetoric.
