...
3. `audits/pending-findings-2026-04-25.md` — most recent prior findings batch.
4. `audits/pending-findings-2026-04-22.md` and `pending-findings-2026-04-23.md` — prior batches; some F-V findings re-surfaced as F-V3↔F8.
