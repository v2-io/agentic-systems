...
7. **Reserved canon decision — Instance-4 / Object-B / CL-2-heavy unification** (Joseph's; one move). Truth established and twice-independently-verified (the spike-routing 2026-05-18 thread); canon carries the §4.1 mark on `#disc-identifiability-floor` Instance 4 + honest tiers; the decision (relabel Instance 4 / install Object B as the genuine 4th floor / land CL-2's heavy refinement / meta-segment renumber) is land-worthy modulo the `audits/SPIKE-VERIFY-471802` repairs. **Durable home: [`PROPOSALS.md`](PROPOSALS.md) §D.9 "RESERVED DECISION (2026-05-18)"** — self-contained there.
