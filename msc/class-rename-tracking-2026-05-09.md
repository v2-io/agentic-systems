...
| File | Count | Status | Notes |
|---|---:|---|---|
| `02-tst-core/src/scope-developer-agent.md` | 2 | modified | [modified by sonnet 2026-05-09: 2 GUC Class-N refs renamed/swapped — "Class 2 / κ≈1 caveat" and "Class 2 architectural classification" (×2) → Class 3 (Coupled) (logogenic/LLM = fully merged = new Coupled); "Class 1 (modular) developer-agents" → Class 1 (Separated); "Class 2 logogenic developer-agents (LLM-based)" → Class 3 (Coupled). Migration note added to Working Notes.] |
| `04-eli/src/def-auxilia-hierarchy.md` | 5 | modified | [modified by sonnet 2026-05-09: 5 GUC Class-N refs — (1) "goal-divergence Class-3 escalation" (old Class 3 = partially modular) → Class 2 (Partial) escalation; (2) "Class-1 composite" → Class 1 (Separated) composite; (3) "Class-3 hallucination at the macro-level" (editorial, old Class 3 = partially modular via strategic equilibrium) → Class 2 (Partial) hallucination; (4) verbatim frozen quote "Class 3 composites from Class 1 sub-agents" (audit §54) UNTOUCHED; (5) Working Notes archaeology description "Class-1 worker" (frozen quote description) UNTOUCHED (Class 1 number unchanged). Three-axis disambiguation: W₀/W₁/W₂ regime letters UNTOUCHED; Class A/B/C admissibility letters UNTOUCHED. Migration note added to Working Notes (includes archaeology-quote rationale).] |
| `04-eli/src/def-imperium-arbitrium-split.md` | 2 | modified | [modified by sonnet 2026-05-09: 2 GUC Class-N refs renamed/swapped — "Class 1 modular agents" → Class 1 (Separated) agents; "strategic-equilibrium-as-Class-3-hallucination pathology" (editorial, old Class 3 = partially modular) → strategic-equilibrium-as-Class-2-(Partial)-hallucination; verbatim italicized quote from frozen audit §14 ("generates Class-3 epistemic corruption") UNTOUCHED per archaeology discipline. Migration note added to Working Notes.] |
| `04-eli/src/scope-eli.md` | 1 | modified | [modified by sonnet 2026-05-09: paragraph at line 52 (added by class-coercion commit 6aae978 before GUC rename, using mixed vocabulary) updated — "Class-1 composite" → Class 1 (Separated) composite; "logogenic Class-3 component" → Class 3 (Coupled) (already semantically correct post-rename; the pre-rename text had a vocabulary inconsistency since logogenic = old Class 2 not old Class 3; post-rename Class 3 Coupled is unambiguously correct); "Class-1-coerced systems" and "Class-1-coerced agent" → Class 1 (Separated)-coerced. No migration note needed: all refs are Class 1 (number unchanged) or Class 3 that was already correct.] |
| `04-eli/src/scope-moral-continuity.md` | 1 | modified | [modified by sonnet 2026-05-09: "Class 1 vs. Class 2" (old vocab: Modular vs. Fully merged = architectural extremes) → "Class 1 (Separated) vs. Class 3 (Coupled)" — semantic reversal: old Class 2 (fully merged) = new Class 3 (Coupled); the comparison is specifically about architectural extremes, not the middle case. Migration note added to newly-created Working Notes section.] |
