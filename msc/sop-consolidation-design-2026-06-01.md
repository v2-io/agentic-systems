...
| Naming cycle + principles | procedure | `doc/naming-principles.md`, `doc/naming-cycle-methodology.md` | `doc/SOP/naming.md` (+ the citability / lexicon-coherence memories folded in) |
...
doc/SOP/
  ...
  naming.md          relocation of naming-principles.md + naming-cycle-methodology.md, with the
