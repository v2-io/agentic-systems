...
- `#deriv-observation-ambiguity-bias-bound` appendix (2026-04-24): expected in `#scope-observation-ambiguity-modulation` and `#result-section-ii-survival` (both in 03-llm-core).
