...
- **Logozoetic agents (`04-eli/`).** I read no segments. AI-welfare implications likely much richer than P1-I and S1 suggest; I'd need to read PROPRIUM ontology to ground them.
