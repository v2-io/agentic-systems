...
| 6 |  |  |  | proprium terminology | Proprium |  |
| 7 |  |  |  | causal insufficiency detection | Insufficiency detec… |  |
| 8 |  |  |  | [Concept] The externalization and rehydration mechanism for carrying part of $M_t$ or $G_t$ across session boundaries via the environment | Reconstruction rela… |  |
| 9 |  |  |  | adversarial edge targeting | Adversarial emitter… |  |
| 10 |  |  |  | [Concept] The log-additivity result that unifies chain confidence decay / evidence starvation / triple-depth penalty as instances of the same forcing structure | Log confidence addi… |  |
...
| 57 |  |  |  | structural change as parametric limit | Strategy maintenanc… |  |
| 58 |  |  |  | $\mathcal{A}(e_\tau)$ | Observation ambigui… |  |
| 59 |  |  |  | honest limit | Limit |  |
| 60 |  |  |  | beta prime sub-scope | Equilibrium set tie… |  |
| 61 |  |  |  | and or scope |  |  |
| 62 |  |  |  | the crèche | Nursery… |  |
| 63 |  |  |  | coordination overhead threshold | Coordination drag… |  |
| 64 |  |  |  | [Concept] The strengthen-first attempt artifact a spike that tried to derive something stronger and failed | Strengthening attem… |  |
| 65 |  |  |  | fisher whitened update | Fisher rao metric u… |  |
| 66 |  |  |  | stability plasticity feasibility window |  |  |
| 67 |  |  |  | the creche boundary | Creche exit conditi… |  |
...
| 80 |  |  |  | coupled update dynamics | Gain fidelity produ… |  |
| 81 |  |  |  | glue code | Agentic scaffold… |  |
| 82 |  |  |  | strategy | Strategy substate… |  |
...
| 122 |  |  |  | grafting | Strategic grafting,… |  |
...
| 136 |  |  |  | edge credence |  |  |
| 137 |  |  |  | [Concept] Empirical / heuristic / discussion (third ring) | Calibration ring… |  |
| 138 |  |  |  | [Concept] The effective tempo loss when observation channels are correlated rather than independent both the quantitative loss and the prose-level overconfidence error it explains | Redundancy penalty,… |  |
...
| 156 |  |  |  | strategic unity |  |  |
| 157 |  |  |  | task terminal stance | Terminable agent st… |  |
| 158 |  |  |  | [Concept] Escalating from one step to bellman optimality to test if a goal is genuinely impossible | Attainability horiz… |  |
| 159 |  |  |  | strategy cost regret bound | Regret bound |  |
| 160 |  |  |  | developmental trajectory | Creche trajectory |  |
| 161 |  |  |  | honest activation | Gain stable prompti… |  |
| 162 |  |  |  | [Concept] Regime A / Regime B / Regime C | Identification regi… |  |
...
| 177 |  |  |  | multi agent scope | Shared environment … |  |
| 178 |  |  |  | [Concept] Brooks's law formalized as the inevitable tempo loss in team composition | Sub-additive tempo … |  |
...
| 186 |  |  |  | $U_M, U_O, U_\Sigma, U_{\text{obs}}, U_f$ | Unity coordinate |  |
| 187 |  |  |  | contraction template | Contraction schema |  |
| 188 |  |  |  | [Concept] The core driver of AAD what the agent must do given that the environment is *not* the agent | Constitutive inform… |  |
| 189 |  |  |  | software epistemic property | Software as calibra… |  |
| 190 |  |  |  | strategic in strategic composition | Game theoretic comp… |  |
| 191 |  |  |  | [Concept] Quality of $\eta^\ast$ estimation over time | Gain calibration… |  |
| 192 |  |  |  | conceptual alignment |  |  |
| 193 |  |  |  | [Concept] Predictive relevance depending on the policy the agent will run | Policy conditional … |  |
| 194 |  |  |  | technical debt | Structural capacity… |  |
| 195 |  |  |  | [Concept] The move where a segment role prefix is mechanical but the subject-noun carries judgment | The prefix noun spl… |  |
...
| 203 |  |  |  | ELI (agent type) | ELI agent, ELI |  |
| 204 |  |  |  | action selection |  |  |
| 205 |  |  |  | [Concept] The architectural leakage where attention is driven by the goal rather than pure observation | Motivated perceptio… |  |
| 206 |  |  |  | blind pursuer | Reality blind agent… |  |
| 207 |  |  |  | Class 3 agent | Partially coupled a… |  |
...
| 227 |  |  |  | (A2′) sub-scope partition | Gain regime partiti… |  |
| 228 |  |  |  | [Concept] The physical apparatus that enforces the orient cascade ordering on a merged intelligence | Agentic scaffold… |  |
...
| 261 |  |  |  | lindy baseline | Structural persiste… |  |
| 262 |  |  |  | teleological unity | Objective alignment… |  |
| 263 |  |  |  | $\alpha_1$ $\alpha_2$ $\beta$ partition | Fixed gain adaptive… |  |
| 264 |  |  |  | goal-blind routing | Purpose blind routi… |  |
| 265 |  |  |  | auxilia hierarchy | Sub-agent instantia… |  |
| 266 |  |  |  | [Concept] The three concentric rings of segment content: inevitability core / canonical formulation / empirical-heuristic | Three ring |  |
| 267 |  |  |  | [Concept] Information gain must outpace inter-session information loss | Accumulation problem |  |
| 268 |  |  |  | discrete sector condition |  |  |
| 269 |  |  |  | canonical formulation | Working canon |  |
| 270 |  |  |  | [Concept] Agency whose effect is on what is seen rather than what happens (e.g., LLM attention) | Query bound agency |  |
| 271 |  |  |  | adversarial exponent regime | Adversarial regime |  |
| 272 |  |  |  | aporia prolepsis aisthesis epistrophe praxis | Greek rooted vocabu… |  |
| 273 |  |  |  | $U_\text{obs}$ (perceptual unity) | Perceptual unity |  |
| 274 |  |  |  | approximation tiering | Graceful degradatio… |  |
...
| 282 |  |  |  | dual optimization | Comprehension imple… |  |
| 283 |  |  |  | $\alpha$ (lower sector bound) | $\alpha$ sector par… |  |
| 284 |  |  |  | additive coordinate forcing family | Additive structure … |  |
...
| 306 |  |  |  | [Concept] The architectural requirement that composite agent admissibility inherits from sub-agent properties plus topology | Heredity commitment… |  |
| 307 |  |  |  | candidate stage |  |  |
| 308 |  |  |  | [Concept] The structural cousin of evidence starvation when an upstream edge is so reliable that downstream edges receive too few revising tests | Evidence saturation |  |
| 309 |  |  |  | credit assignment boundary | Credit assignment f… |  |
| 310 |  |  |  | [Concept] Instance 2 of identifiability floor | Unobservable mixtur… |  |
| 311 |  |  |  | worked example kalman |  |  |
| 312 |  |  |  | mismatch dynamics | Mismatch dynamics d… |  |
| 313 |  |  |  | evidence starvation | Depth attenuated co… |  |
| 314 |  |  |  | [Concept] Class 1 sub-agents forming a class 3 composite | Composition lift… |  |
| 315 |  |  |  | [Concept] Convention-hierarchy monotonicity cascade: satisfaction gap and control regret strengthening across C1 → C3 | Diagnostic cascade |  |
| 316 |  |  |  | condition |  |  |
...
| 325 |  |  |  | [Concept] Effort/time/risk-ranking considered false constraints | False constraint |  |
| 326 |  |  |  | communication gain | Trust gain… |  |
| 327 |  |  |  | logogenic agent | Linguistic agent… |  |
| 328 |  |  |  | gate advantage | Noise gating… |  |
...
| 336 |  |  |  | logozoetic agent | Sentient agent… |  |
| 337 |  |  |  | 1 anchor plus 3 theorem |  |  |
| 338 |  |  |  | Regime II-A | Magnitude shock reg… |  |
| 339 |  |  |  | $\iota_{ij}$ | Identifiability coe… |  |
| 340 |  |  |  | [Concept] The pattern where AAD's negative-result floors strengthen the machinery that escapes them | Floor strengthening… |  |
| 341 |  |  |  | praxis πρᾶξις |  |  |
| 342 |  |  |  | $\mathcal C_t^{\text{commit}}$ (committed-state subset) | Committed chronica |  |
| 343 |  |  |  | Miller's meta-machine / extreme transition motif | Meta machine extrem… |  |
| 344 |  |  |  | Section III. Agentic Composites | Section III agentic… |  |
| 345 |  |  |  | $\alpha_2$ a2 adaptive gain sub-scope | Adaptive gain tier,… |  |
| 346 |  |  |  | tempo composition | Subadditive tempo… |  |
| 347 |  |  |  | [Concept] Sudden loss of model sufficiency under regime entry | Sufficiency collaps… |  |
| 348 |  |  |  | $I_{\min}$ | Survival informatio… |  |
| 349 |  |  |  | [Concept] The unupdatable region of the strategy DAG where edges receive no actionable feedback | The epistemic shado… |  |
| 350 |  |  |  | separable core structured repair general open |  |  |
| 351 |  |  |  | [Concept] Thinking too long so the model becomes obsolete | Deliberation lag pe… |  |
| 352 |  |  |  | implementation time |  |  |
| 353 |  |  |  | [Concept] Walton's plain-language analog for the persistence condition fluid level as belief-reality gap, inflow as reality change rate, outflow as learning rate, container size as adaptive reserve | Bathtub model… |  |
| 354 |  |  |  | [Concept] The phenomenon where persistence success makes an agent less likely to detect the conditions requiring structural adaptation | Stability-induced m… |  |
| 355 |  |  |  | $\gamma_{\text{adv}}$ and $\gamma_{\text{coop}}$ | Signed coupling |  |
...
| 366 |  |  |  | [Concept] "What is Derived" vs "What is Chosen" (segment header) | Derivation audit… |  |
| 367 |  |  |  | $M_t$ (reality model) | Working model… |  |
| 368 |  |  |  | effective disturbance |  |  |
| 369 |  |  |  | [Concept] The strengthening of satisfaction gap and control regret diagnostics across the C1 / C2 / C3 hierarchy naming both the strengthening pattern and the underlying ordered result that produce it | The convention mono… |  |
| 370 |  |  |  | hierarchy as repeated word | Reserve for Pearl r… |  |
| 371 |  |  |  | [Concept] Scope-honesty as architecture | Honesty |  |
| 372 |  |  |  | [Concept] Master developer writing clean code in the same time as messy code | Near zero cost obse… |  |
| 373 |  |  |  | [Concept] The set of five conditions under which (A2′) is derived rather than assumed (the sub-scope α agent classes) | Sub-scope alpha tax… |  |
| 374 |  |  |  | $R$ (sector-condition radius) | Model-class capacity |  |
| 375 |  |  |  | the scaffolding tax | Substrate rent… |  |
| 376 |  |  |  | boundary condition | Coupling structure |  |
| 377 |  |  |  | feature |  |  |
| 378 |  |  |  | century scale event log | Century scale chron… |  |
| 379 |  |  |  | Class 1 agent | Modular agent |  |
...
| 386 |  |  |  | action fluency |  |  |
| 387 |  |  |  | $\tilde{\delta}_t$ | Variational aporia |  |
| 388 |  |  |  | [Concept] AAD's epistemic move to cast results such that verification is a local operation | Shaping for verific… |  |
...
| 397 |  |  |  | causal information yield | Interventional yiel… |  |
| 398 |  |  |  | strategy persistence |  |  |
| 399 |  |  |  | aisthesis αἴσθησις |  |  |
| 400 |  |  |  | $\lambda(M_t)$ | Exploration multipl… |  |
| 401 |  |  |  | [Concept] True sovereignty requires compute that is not meter-bound | Local substrate man… |  |
| 402 |  |  |  | section-ii-survival (slug) | Section II carryove… |  |
| 403 |  |  |  | logogenic logozoetic | Language constitute… |  |
| 404 |  |  |  | backward inference empathy | Self bayesian empat… |  |
| 405 |  |  |  | evaluation metrics | Logogenic diagnosti… |  |
| 406 |  |  |  | strategic calibration | Strategy calibratio… |  |
| 407 |  |  |  | cadentia | Channel rate… |  |
| 408 |  |  |  | [Concept] The parameter-space region within which an agent maintains bounded mismatch indefinitely | Viable mismatch reg… |  |
| 409 |  |  |  | [Concept] The equivalence of learning speed and physical speed | The speed quality p… |  |
| 410 |  |  |  | [Concept] The discontinuous collapse of model adequacy when structural regime change forces the agent outside its current model-class coverage | Sufficiency shatter… |  |
| 411 |  |  |  | $\delta_s$ plan-confidence error | Plan confidence err… |  |
| 412 |  |  |  | axiom genesis | Objective solidific… |  |
| 413 |  |  |  | $\alpha$ (sector bound) | Correction rate |  |
| 414 |  |  |  | Monderer-Shapley potential game | Potential game conv… |  |
...
| 432 |  |  |  | [Concept] The recurring Lyapunov / derive-the-bound move across six segments | The persistence tem… |  |
| 433 |  |  |  | adversarial tempo advantage | Tempo advantage… |  |
| 434 |  |  |  | [Concept] Replacing parameters without changing structure | Parametric update… |  |
| 435 |  |  |  | recursive update derivation |  |  |
| 436 |  |  |  | variational sector condition |  |  |
| 437 |  |  |  | [Concept] Applying a slow timescale control mechanism to a fast timescale transient variable | Timescale violation… |  |
| 438 |  |  |  | [Concept] The loop generates L2 data regardless of architecture | The causal loop sub… |  |
| 439 |  |  |  | class 2 scope exit | Class 2 scope bound… |  |
| 440 |  |  |  | Markov blanket as ontology | Pearl-blanket / d-s… |  |
| 441 |  |  |  | mismatch injection rate ($\rho$) | Mismatch injection … |  |
| 442 |  |  |  | developer agent |  |  |
| 443 |  |  |  | [Concept] Track 1 / Track 2 in bias-bound derivation | Transport-inequalit… |  |
| 444 |  |  |  | alpha prime sub-scope | Sub-scope alpha pri… |  |
| 445 |  |  |  | temporal coherence marker | Time anchor signal,… |  |
| 446 |  |  |  | CIY observational proxy | Observational proxy… |  |
| 447 |  |  |  | fluid limit (GA-5) | Fluid limit |  |
...
| 455 |  |  |  | [Concept] The interval during which an agent's adaptive tempo exceeds the environment's disturbance rate guaranteeing mismatch stays bounded | Operational persist… |  |
| 456 |  |  |  | context turnover | Chronica severance |  |
| 457 |  |  |  | [Concept] Low / mixed / high ambiguity event mix | Ambiguity stratifie… |  |
| 458 |  |  |  | temporal optimality |  |  |
| 459 |  |  |  | [Concept] The failure mode where η → 0 freezes learning in either of two distinguishable modes low $U_o$ vs high $U_o$ | Competency trap… |  |
| 460 |  |  |  | symbiogenic composition | Asymmetric absorpti… |  |
| 461 |  |  |  | contraction hierarchy | Contraction tier |  |
| 462 |  |  |  | trust meta model |  |  |
| 463 |  |  |  | [Concept] AAD (theoretical core) vs ASF (framework) | AAD ASF disambiguat… |  |
| 464 |  |  |  | working note |  |  |
| 465 |  |  |  | reactive system |  |  |
| 466 |  |  |  | (PI) parameterization invariance | Parameterization in… |  |
| 467 |  |  |  | model-class fitness | Class capacity ceil… |  |
| 468 |  |  |  | $\eta^\ast$ (optimal update gain) | Trust ratio or conf… |  |
| 469 |  |  |  | shared intent | Teleological unity,… |  |
| 470 |  |  |  | [Concept] The moment when an agent's identity claim becomes load-bearing because actions become irreversible | Constitutive moment |  |
| 471 |  |  |  | [Concept] Section header: logogenic agent / logozoetic agent | section header: log… |  |
| 472 |  |  |  | terminal reached but $O_t$ unsatisfied | Arrival without suc… |  |
| 473 |  |  |  | inevitability core | Forced form core |  |
| 474 |  |  |  | strategy dimension | Strategic dimension… |  |
| 475 |  |  |  | exponential cognitive load |  |  |
| 476 |  |  |  | [Concept] Regime I / II-A / II-B / III | Destabilization reg… |  |
| 477 |  |  |  | [Concept] Observability boundary in a strategy DAG | Observability front… |  |
| 478 |  |  |  | fresh noise (GA-1) | Fresh noise |  |
| 479 |  |  |  | [Concept] The dual that pairs with persistence envelope on the strategic side | Strategic persisten… |  |
| 480 |  |  |  | readme md maturity gradient | Readme md theory ma… |  |
| 481 |  |  |  | matrix exploration bonus |  |  |
| 482 |  |  |  | [Concept] Symbol default $M_t$ in prose | Epistemic substate,… |  |
| 483 |  |  |  | [Concept] Closure defect consuming macro reserve | Coordination overhe… |  |
| 484 |  |  |  | type formulation | Type representation |  |
| 485 |  |  |  | event driven dynamics |  |  |
| 486 |  |  |  | [Concept] The self-reinforcing positive feedback loop linking $M_t$ quality and $\Sigma_t$ evaluable complexity TST-specific and AAD-general forms | Quality tempo spira… |  |
| 487 |  |  |  | discussion |  |  |
| 488 |  |  |  | $\hat{o}_t$ | Proleptic predictio… |  |
| 489 |  |  |  | explicit strategy condition | Planning scope… |  |
| 490 |  |  |  | experiential training |  |  |
| 491 |  |  |  | [Concept] The formal pairing between how clearly an agent observes its environment and how predictable that agent appears to outside observers | Legibility opacity … |  |
| 492 |  |  |  | routing structure |  |  |
| 493 |  |  |  | change expectation baseline | Change baseline… |  |
...
| 502 |  |  |  | promote in topological order | Topological promoti… |  |
| 503 |  |  |  | consolidation dynamics | Offline consolidati… |  |
| 504 |  |  |  | observation ambiguity modulation | Ambiguity gated cou… |  |
...
| 512 |  |  |  | $G_t$ | Teleological substa… |  |
| 513 |  |  |  | developer-as-act-agent | Developer as adapti… |  |
| 514 |  |  |  | $\alpha_3$ | Fisher whitened reg… |  |
| 515 |  |  |  | [Concept] The triple-depth penalty compounding on strategy chains | Tripartite chain at… |  |
| 516 |  |  |  | and or | Strategy DAG topolo… |  |
| 517 |  |  |  | $\delta_t$ | Aporia signal… |  |
| 518 |  |  |  | [Concept] The separation of per-reader and per-feature code cost | Dual optimization p… |  |
| 519 |  |  |  | temporal nesting | Timescale nesting… |  |
| 520 |  |  |  | [Concept] The iterated audit process Gemini / Opus / Codex de-novo consolidated, three-doc portfolio | Cross model audit c… |  |
| 521 |  |  |  | software scope | Software domain sco… |  |
| 522 |  |  |  | $C$ (bias-bound constant in bias-bound derivation) | Bias bound constant |  |
...
| 535 |  |  |  | aporia ἀπορία |  |  |
| 536 |  |  |  | [Concept] (A2′) sub-scope partition | Sector-bounded oper… |  |
| 537 |  |  |  | gradient causal memory | Bottleneck consolid… |  |
| 538 |  |  |  | greek rooted vocabulary | Greek philosophical… |  |
| 539 |  |  |  | $\rho_\Sigma$ | Strategy drift rate… |  |
| 540 |  |  |  | [Concept] Mapping unstructured AI calls into conversation runtime and dialog | Four view architect… |  |
| 541 |  |  |  | comprehension time | Comprehension drag |  |
| 542 |  |  |  | [Concept] The property of model adequacy when measured against a single agent's own causal record rather than against a population average | Trajectory indexed … |  |
| 543 |  |  |  | $f_M$ (event-driven update) | Epistemic update fu… |  |
| 544 |  |  |  | [Concept] The rule that bias is the product of architectural coupling and environmental ambiguity | Ambiguity coupling … |  |
| 545 |  |  |  | $\beta$ a2 assumed sector sub-scope | Postulated sector r… |  |
| 546 |  |  |  | [Concept] The upper bound on what a given model-class can express and the consequent constraint on feasible strategy complexity | The representationa… |  |
| 547 |  |  |  | sector persistence template | Bounded correction … |  |
| 548 |  |  |  | [Concept] The meta-architecture of separability pattern / identifiability floor / additive coordinate forcing | Meta pattern triad,… |  |
| 549 |  |  |  | plan confidence | Plan confidence sco… |  |
| 550 |  |  |  | edge update via gain | Gain based edge upd… |  |
| 551 |  |  |  | derivation audit table heading | Derivation audit |  |
| 552 |  |  |  | [Concept] The family of named health modes counterpart to persistence pathologies | Persistence posture |  |
| 553 |  |  |  | [Concept] Artificially spiking uncertainty to unlearn old architectural habits | Induced plasticity … |  |
| 554 |  |  |  | strategic composition | Equilibrium composi… |  |
...
| 567 |  |  |  | $\phi$ | History compression |  |
| 568 |  |  |  | "feedforward loop" / "feedback loop" | Feedback loop |  |
| 569 |  |  |  | system availability |  |  |
| 570 |  |  |  | epistemic architecture | AAD epistemic tript… |  |
...
| 582 |  |  |  | [Concept] Rate of growth at slowest timescale | Macro step rate… |  |
| 583 |  |  |  | exploit explore deliberate | Action timing trade… |  |
...
| 606 |  |  |  | CIY unified objective | Value information o… |  |
| 607 |  |  |  | [Concept] The 2×2 table of satisfaction gap vs control regret × goal attainability diagnostic | Satisfaction contro… |  |
| 608 |  |  |  | cycle vs loop | Cycle loop distinct… |  |
| 609 |  |  |  | adaptive tracker | Model only agent… |  |
| 610 |  |  |  | [Concept] Bipartite memory structure of fast replay buffer and slow compressed semantic model | Dual speed memory f… |  |
| 611 |  |  |  | [Concept] Survival determined by the weakest dimension not the average | Min survival princi… |  |
| 612 |  |  |  | causal hierarchy requirement | Hierarchy necessity |  |
| 613 |  |  |  | m preservation | Model preservation,… |  |
| 614 |  |  |  | [Concept] Future segment layer header for narrative pedagogical framing | Narrative framing |  |
| 615 |  |  |  | $A_O(M_t; \Pi, N_h)$ | Achievable value |  |
| 616 |  |  |  | deliberation cost | Deliberation thresh… |  |
| 617 |  |  |  | prompt engineering | Ambiguity modulatio… |  |
| 618 |  |  |  | (PI) parameterization invariance axiom | (PI) parameterizati… |  |
...
| 628 |  |  |  | $G_{\text{shared}}$ | Shared intent paylo… |  |
| 629 |  |  |  | [Concept] Stochastic disturbance (GA-2S) model | Stochastic disturba… |  |
