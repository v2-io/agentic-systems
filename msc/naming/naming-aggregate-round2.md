...
**Round 1 agents:** agent1-original-brainstorm, codex-1, codex-2, gemini-1, gemini-2, haiku-4-5, opus-1m, opus-4-7, opus-4-7-b, sonnet-4-6
...
## 1. `#identifiability-floor`

**Alternatives proposed:** `#identifiability-floor`, `#no-go theorems`
...
## 4. `AAD (Adaptation and Actuation Dynamics)`

**Alternatives proposed:** `AAD (Adaptation and Actuation Dynamics)`, `AAD`, `AAD (Agentic Adaptation Dynamics)`

- `AAD (Adaptation and Actuation Dynamics)` — **agent1-original-brainstorm:** Recent rename (2026-04-16); further thrash dilutes identity. "Actuation" imperfection is real but a Section II preamble clarification handles it more cheaply than another rename.
- `AAD (Adaptation and Actuation Dynamics)` — **codex-1:** "Actuation" is imperfect, but framework-level churn is more expensive than the remaining mismatch; clarify in prose rather than rename again.
- `AAD (Adaptation and Actuation Dynamics)` — **codex-2:** The rename cost has already been paid; the short form is now compact, distinctive, and good enough to keep.
- `AAD (Adaptation and Actuation Dynamics)` — **gemini-1:** Recent rename; "Actuation" is slightly imperfect for Section II but further churn dilutes identity. Keep.
- `AAD (Adaptation and Actuation Dynamics)` — **haiku-4-5:** Recent rename (2026-04-16) from Agentic Cycle Theory. Further churn is expensive; identity is now locked in. The "Actuation" imperfection is real but manageable via a Section II preamble. Do not rename the framework. Keep.
- `AAD (Adaptation and Actuation Dynamics)` — **opus-4-7-b:** Do not rename. The rename from ACT happened on 2026-04-16 (six months ago at this date); further churn dilutes the identity when the framework is starting to be cited. Any fresh alternative would face the same collision-checking burden that ACT did. **However:** the "Actuation" half is a genuinely weaker fit than "Adaptation" for what Section II covers (Section II is purposeful agency with objectives and strategy; "actuation" in engineering means *mechanical output*). The fix is not a rename but a Section II preamble paragraph that explicitly names "actuation" in AAD's specific sense ("actuated toward an objective" — already in LEXICON Agent-Classes, but needs to be surfaced at Section II preamble level).
- `AAD (Adaptation and Actuation Dynamics)` — **opus-4-7:** Recent (2026-04-16) rename to resolve the "AI Consciousness Test" collision; further churn dilutes identity. The "Actuation"-vs-Section-II imperfection is a preamble clarification not a rename.
- `AAD (Adaptation and Actuation Dynamics)` — **sonnet-4-6:** Recent rename (2026-04-16) from ACT; citation velocity is building under the new name. The "Actuation" imperfection noted in the naming-principles file is real (Section II is more about purposeful actuation than mechanical actuation) but the Section II preamble handles it. Further churn would cost more than it gains. Keep.
...
## 7. `#chain-confidence-decay`

**Alternatives proposed:** `#chain-confidence-decay`
...
## 8. `#contraction-template`

**Alternatives proposed:** `#contraction-template`
...
## 9. `#directed-separation`

**Alternatives proposed:** `#directed-separation`
...
**Alternatives proposed:** `#agent-opacity`, `#strategic-opacity`, `#emitter-opacity`
...
## 14. `#separability-pattern`

**Alternatives proposed:** `#separability-pattern`, `#separability-ladder`, `#tiered-separability`, `#scope-staircase`, `#three-rung-posture`, `#separability-staircase`
...
- `#scope-staircase` — **agent1-original-brainstorm:** Too metaphorical.
...
## 15. `scope-honesty-as-architecture`

**Alternatives proposed:** `scope-honesty-as-architecture`, `architectural scope honesty`

- `scope-honesty-as-architecture` — **codex-1:** Hyphen-heavy, but uniquely exact. The phrase says the limits are part of the construction, not editorial cleanup.
- `scope-honesty-as-architecture` — **codex-2:** Strong internal principle name; it sounds like a thesis, not a slogan.
- `scope-honesty-as-architecture` — **haiku-4-5:** Central to CLAUDE.md's "Epistemic architecture as AAD's distinctive contribution" principle. Already in project vocabulary as a narrative-level principle; no need to formalize as a segment. Keep the current form.
- `scope-honesty-as-architecture` — **opus-1m:** CLAUDE.md §7 element (a). Working term; keep.
...
- `## Working Notes` — **codex-1:** This is established public API across segments and FORMAT.md; clearer than most substitutes and not worth churn.
- `## Working Notes` — **codex-2:** Clear, conventional, and exactly right for the internal/public boundary it marks.
...
**Alternatives proposed:** `#shared-intent`, `#compressed-purpose`
...
## 24. `information bottleneck`

**Alternatives proposed:** `information bottleneck`
...
## 27. `α₂ (A2' adaptive-gain sub-scope)`

**Alternatives proposed:** `adaptive-gain regime`

- `adaptive-gain regime` — **agent1-original-brainstorm:** Parallel to α₁.
...
- `adaptive-gain regime` — **haiku-4-5:** Parallel to α₁ English equivalent. Already used informally. LEXICON entry would formalize.
- `adaptive-gain regime` — **opus-1m:** Parallel to α₁.
- `adaptive-gain regime` — **opus-4-7:** Parallel construction to α₁ rename.
- `adaptive-gain regime` — **sonnet-4-6:** Parallel to α₁. "Adaptive-gain regime" communicates that K is itself a state variable. Same gloss-addition proposal: keep symbol, add English.

## 28. `α₁ (A2' fixed-gain sub-scope)`

**Alternatives proposed:** `derived-gain regime`, `fixed-gain regime`

- `derived-gain regime` — **agent1-original-brainstorm:** English equivalent for prose. "This lands in the derived-gain regime" reads naturally. Keep α₁ as shorthand symbol.
- `derived-gain regime` — **haiku-4-5:** In prose, "α₁ regime" is hard to distinguish from "a₁ regime" when read aloud. English equivalent "derived-gain regime" emphasizes that A2' is derived under directional fidelity. Would keep Greek symbols in formal segments and NOTATION; add English equivalent to LEXICON for prose fluency. Prose-accessibility enhancement, not a symbol rename.
- `derived-gain regime` — **opus-1m:** English equivalent for prose use. Keep α₁ as symbol.
- `derived-gain regime` — **opus-4-7-b:** "The Kalman case lands in α₁" requires a decoder ring; "the Kalman case lands in the derived-gain regime" is self-contained. Symbol stays as shorthand; English owns the prose register.
- `derived-gain regime` — **opus-4-7:** "Lands in α₁" is cryptic in prose; "lands in the derived-gain regime" reads. Keep α₁ as symbolic shorthand but surface the English in segment text.
...
## 29. `#approximation-tiering`

**Alternatives proposed:** `#approximation-tiering`, `#tiered-approximation`, `#approximation-ladders`, `#tier-ascension`
...
- `#approximation-ladders` — **codex-2:** Noun beats gerund here; "ladders" is easier to say alongside the segment's own ladder language.
- `#tier-ascension` — **opus-4-7:** Reads like a ranked-climbing metaphor the segment does not actually use. Reject.

## 30. `#bias-bound-derivation`

**Alternatives proposed:** `#bias-bound-derivation`

- `#bias-bound-derivation` — **haiku-4-5:** Class-2 observation-ambiguity bias-bound constant C. "Bias-bound derivation" is compound but clear. Keep.
- `#bias-bound-derivation` — **opus-4-7:** Newly landed appendix; name matches content. Keep.
...
## 31. `#communication-gain`

**Alternatives proposed:** `#communication-gain`
...
**Alternatives proposed:** `#recursive-update`
...
- `closure defect` — **opus-4-7-b:** The English prose name is fine; the asterisk is doing "optimum-over-admissible-projections" work that the bare ε doesn't. Keep symbol; ensure segments using it say "closure defect" in prose, not "epsilon-star".
...
## 35. `"structural adaptation"`

**Alternatives proposed:** `structural adaptation`
...
## 36. `## Discussion (segment section header)`
...
## 37. `## Epistemic Status (segment section header)`
...
## 39. `## Formal Expression (segment section header)`
...
## 40. `## Working Notes (segment section header)`
...
## 41. `#additive-coordinate-forcing`

**Alternatives proposed:** `#forced-coordinates`, `#uniqueness-coordinate-forcing`, `#coordinate-forcing`, `#additive-coordinate-forcing`, `#cauchy-coordinates`, `#logarithmic-lift`, `#log-coordinate-forcing`, `#anchor-lattice`, `#additive-lift`, `#axiom-forcing`

- `#forced-coordinates` — **codex-1:** The current name is accurate but over-explains the mechanism. "Forced coordinates" is shorter, more noun-like, and broad enough to cover the metric-layer case too.
- `#forced-coordinates` — **codex-2:** Too breezy and it drops the uniqueness-theorem discipline that makes the segment interesting.
- `#forced-coordinates` — **gemini-1:** "Forced coordinates" is broader and more scope-honest for the various layers involved.
- `#forced-coordinates` — **opus-1m:** The segment carries four primary instances: three via Cauchy functional equation (chain / divergence / update) and one via Čencov-invariance (metric). The segment itself states (line 50): "Both clear the broader discipline — uniqueness-theorem-forced coordinate under AAD-internal axiom — but via distinct uniqueness-theorem machineries." Naming the meta-pattern after only one machinery (Cauchy) violates the scope-honesty the segment just established. "Forced coordinates" covers both machineries. Preserves "additive-coordinate-forcing" as long-form in the segment subtitle.
- `#forced-coordinates` — **opus-4-7:** The Čencov fourth primary instance forces the Fisher metric, which is not log-additive — the current name advertises three-out-of-four. "Forced coordinates" covers both Cauchy-FE and Čencov machineries without overpromising additivity. The segment itself flags this in the Discussion. Candidate.
- `#forced-coordinates` — **sonnet-4-6:** Passive noun; loses the process-verb structure that "forcing" has. A reader encountering it first might not know what forces them.
...
- `#cauchy-coordinates` — **agent1-original-brainstorm:** Weak preference. Names the mechanism and the output; short and crisp. Downside: "Cauchy" overloaded in math. Retain additive-coordinate-forcing as long-form subtitle.
- `#cauchy-coordinates` — **opus-1m:** Explicit rejection. The Čencov metric-layer 4th primary instance is NOT Cauchy-FE; naming the meta-pattern for one of two machineries violates the scope-honesty commitment the segment establishes in its own Discussion section. Short and crisp, but scope-dishonest.
...
## 42. `#adversarial-destabilization`
...
## 43. `#agent-environment`

**Alternatives proposed:** `#agent-environment`
...
**Alternatives proposed:** `#agent-identity`, `#trajectory-identity`, `#causal-identity`
...
## 45. `#ai-agent-as-act-agent`

**Alternatives proposed:** `#ai-agent-as-adaptive-agent`, `#ai-agent-as-aad-agent`

- `#ai-agent-as-adaptive-agent` — **agent1-original-brainstorm:** P1 mechanical, parallel to #developer-as-adaptive-agent rename.
- `#ai-agent-as-adaptive-agent` — **opus-1m:** Parallel rename; same reasoning.
- `#ai-agent-as-aad-agent` — **codex-1:** Same issue as the developer segment: the slug should not force readers to remember an internal shortening.
- `#ai-agent-as-aad-agent` — **codex-2:** Same problem as the developer segment, and more visible because AI readers will hit it early.

## 46. `#causal-information-yield`

**Alternatives proposed:** `#causal-information-yield`
...
## 47. `#changeset-size-principle`

**Alternatives proposed:** `#changeset-size-principle`
...
## 51. `#credit-assignment-boundary`

**Alternatives proposed:** `#credit-assignment-boundary`
...
## 53. `#independence-audit`

**Alternatives proposed:** `#independence-audit`
...
## 54. `#interaction-channel-classification`

**Alternatives proposed:** `#signal-reception-regimes`, `#interaction-channel-classification`, `#recipient-regime-classification`, `#interaction-regimes`, `#recipient-side-channel-taxonomy`

- `#signal-reception-regimes` — **codex-1:** The four regimes are the actual memorable object here. The current name reads like taxonomy boilerplate.
- `#signal-reception-regimes` — **codex-2:** Current name is clinical and forgettable; the segment really names how incoming signals land.
...
**Alternatives proposed:** `#model-preservation`, `#epistemic-externalization`
...
## 60. `Adaptive reserve ($\Delta\rho^\ast$)`
...
## 63. `Auftragstaktik principle`

**Alternatives proposed:** `Auftragstaktik principle`
...
## 65. `Closure defect ($\varepsilon^\ast$)`
...
- `H_b` — **agent1-original-brainstorm:** Adopted concept; AAD adds observer/horizon/trajectory indexing but keeps the symbol.
- `H_b` — **opus-1m:** Adopted; keep.

## 67. `Lohmiller-Slotine contraction`
...
## 68. `Miller's meta-machine / extreme transition motif`
...
## 74. `adaptive reserve ($\Delta\rho^\ast$)`
...
## 79. `composition closure / closure defect (ε*)`
...
## 80. `exploit / explore / deliberate`

**Alternatives proposed:** `exploit / explore / deliberate`
...
## 81. `prolepsis / aisthesis / aporia / epistrophe / praxis`
...
## 83. `strengthen-first posture`

**Alternatives proposed:** `strengthen-first posture`, `attempt the improbable`
...
## 87. `#change-expectation-baseline`
...
## 88. `#consolidation-dynamics`

**Alternatives proposed:** `#consolidation-dynamics`, `#offline-consolidation`

- `#consolidation-dynamics` — **haiku-4-5:** Offline regime of between-event M_t dynamics; "consolidation" reads naturally (consolidating learned structure). Captures the sense of replay-driven model tightening. Acceptable name. Keep.
- `#consolidation-dynamics` — **opus-4-7:** Fine. Inherits "consolidation" from neuroscience (memory consolidation). Keep unless a sharper name emerges.
...
## 89. `#loop-interventional-access`

**Alternatives proposed:** `#loop-interventional-access`, `#interventional-loop-access`, `#interventional-feedback`, `#adaptive-loop-access`, `#loop-level2-access`
...
## 91. `#adaptive-gain-dynamics`

**Alternatives proposed:** `#adaptive-gain-dynamics`

- `#adaptive-gain-dynamics` — **haiku-4-5:** A2' under adaptive gain: meta-gain conditions (MG-1)–(MG-4). Compound but functional. Keep.
...
**Alternatives proposed:** `#agent-model`
...
**Alternatives proposed:** `#agent-spectrum`, `#agency-spectrum`
...
## 94. `#auftragstaktik-principle`

**Alternatives proposed:** `#auftragstaktik-principle`, `#mission-command-principle`, `#mission-command principle`, `#objective-first bandwidth principle`
...
**Alternatives proposed:** `#causal-insufficiency-detection`, `#latent-cause-detection`
...
## 96. `#code-quality-as-observation-infrastructure`

**Alternatives proposed:** `#code-quality-as-observation-infrastructure`, `#observation-infrastructure`
...
## 97. `#complete-agent-state`

**Alternatives proposed:** `#complete-agent-state`
...
## 98. `#compression-operations`

**Alternatives proposed:** `#compression-operations`, `#ib-unification`

- `#compression-operations` — **haiku-4-5:** Shared IB shape across M_t, Σ_t, shared intent, Λ. "Compression operations" reads naturally for the four instances unified under IB. Keep.
- `#compression-operations` — **sonnet-4-6:** Fine, but "operations" is vague. The segment is about IB-shaped compression across four AAD quantities.
- `#ib-unification` — **sonnet-4-6:** Overclaims — the Discussion explicitly says unification is at U-medium not U-strong. The current name is more honest.

## 99. `#exploit-explore-deliberate`
...
## 100. `#gain-sector-bridge`

**Alternatives proposed:** `#gain-sector-bridge`
...
## 101. `#graph-structure-uniqueness`

**Alternatives proposed:** `#graph-structure-uniqueness`, `#strategy-dag-sufficiency`, `#dag-structure-derivation`, `#graph-structure-sufficiency`
...
**Alternatives proposed:** `#l1-update-bias`

- `#l1-update-bias` — **haiku-4-5:** Closed-form bias formula for log-odds update under L1' common cause. "L1-update-bias" reads as "bias in L1 scenario under update dynamics." Acceptable name. Keep.
...
**Alternatives proposed:** `#scope-condition`

- `#scope-condition` — **haiku-4-5:** Defines where AAD applies. Short, descriptive. Specialist vocabulary (scope honesty is architectural principle). Acceptable. Keep.
- `#scope-condition` — **sonnet-4-6:** The simplest possible name for what it is. Used throughout. Not eligible for improvement. Keep.

## 105. `#variational-sector-condition`
...
## 106. `$\hat P_\Sigma$ (plan confidence)`
...
## 107. `Agentic Systems Framework (ASF)`
...
## 112. `"Actuated" (vs. Purposeful, goal-oriented)`
...
## 120. `"I. Adaptive Systems Under Uncertainty"`
...
## 121. `"Inevitability core" (the ~15 segments where inevitability is plausible)`
...
## 122. `"Logogenic" (vs. Language-based, LLM-based)`

**Alternatives proposed:** `Logogenic`

- `Logogenic` — **sonnet-4-6:** Names the structural property. Keep.

## 123. `"Logozoetic" (vs. Conscious AI, sentient agent)`
...
## 124. `"Pearl-blanket conservative form" (of Markov blanket in #directed-separation)`
...
## 125. `"Pearl-blanket vs Friston-blanket" terminology (Bruineberg et al.)`
...
## 128. `"actuated agent" vs "purposeful agent"`
...
## 131. `"calibration laboratory" (software's role)`
...
## 140. `"logogenic agent" vs "LLM agent"`
...
## 141. `"meta-segment" (for #separability-pattern, #identifiability-floor, #additive-coordinate-forcing)`
...
## 143. `"observation ambiguity" (#observation-ambiguity-modulation)`
...
## 145. `"plan confidence" ($\hat P_\Sigma$)`
...
## 149. `"scope-honesty-as-architecture"`

**Alternatives proposed:** `scope-honesty-as-architecture`, `scope honesty as architecture`

- `scope-honesty-as-architecture` — **sonnet-4-6:** Already coined and working. Appears in CLAUDE.md and multiple segments. The compound noun is memorable and the hyphenation is correct (it's an adjectival phrase). Keep.
- `scope honesty as architecture` — **opus-4-7-b:** The hyphens signal "this is a concept-name, not a description" — useful in CLAUDE.md but awkward in running prose. Proposal: keep the hyphenated form only in CLAUDE.md §7 and README §reading-AAD where it is a named concept; use unhyphenated "scope honesty" in segment-level prose.

## 150. `"segment" (for claim files)`
...
## 152. `"stability-plasticity feasibility window"`
...
## 153. `"strategic" in `#strategic-composition``
...
## 154. `"strengthen-first posture"`

**Alternatives proposed:** `strengthen-first`, `"attempt the improbable"`
...
## 155. `"structural persistence" / "operational persistence" / "continuity persistence"`
...
## 157. `"the adaptive cycle" (as the theory's fundamental unit)`
...
## 158. `"token-level commitment" (for #agent-identity)`
...
## 164. `#change-proximity-principle`

**Alternatives proposed:** `#change-proximity-principle`, `#change-locality-principle`
...
## 165. `#ciy-unified-objective`

**Alternatives proposed:** `value-information objective`, `#ciy-unified-objective`
...
## 166. `#composition-closure`

**Alternatives proposed:** `#coarse-graining closure`, `#composition-closure`, `#macro-agent-criterion`
...
## 167. `#composition-consistency`

**Alternatives proposed:** `#composition-consistency`, `#scale-invariance`
...
## 170. `#deliberation-cost`

**Alternatives proposed:** `#deliberation-cost`

- `#deliberation-cost` — **haiku-4-5:** Think vs. act tradeoff. Reads naturally as cost-benefit. Keep.

## 171. `#information-bottleneck`
...
## 173. `#model-sufficiency`

**Alternatives proposed:** `#model-sufficiency`

- `#model-sufficiency` — **haiku-4-5:** Clear definition: how well the model captures predictive information. Short, evocative. Keep.

## 174. `#observation-ambiguity-modulation`

**Alternatives proposed:** `#goal-resolvable-ambiguity`, `#ambiguity-gated-coupling`
...
## 179. `#section-ii-survival`

**Alternatives proposed:** `#section-ii-carryover-map`, `#section-ii carryover classification`
...
## 180. `#software-epistemic-properties`

**Alternatives proposed:** `#software-epistemic-properties`, `software as calibration laboratory`

- `#software-epistemic-properties` — **codex-2:** Plain, strong, and exactly what the segment is doing.
...
## 181. `#unity-dimensions`

**Alternatives proposed:** `#unity-dimensions`, `#coherence-dimensions`

- `#unity-dimensions` — **haiku-4-5:** 4 dimensions of coherence (U_M, U_O, U_Σ, plus a fourth candidate under discussion). "Unity dimensions" reads naturally; "unity" captures the coordinating principle. Keep.
- `#coherence-dimensions` — **codex-2:** "Unity" is a little vague and already crowded by related uses; "coherence" says what is being measured.

## 182. `#value-object`

**Alternatives proposed:** `#value-object`, `#decision-value`
...
## 183. `$U_M$ (dual-use: model uncertainty and epistemic unity)`
...
## 185. `(PI) parameterization-invariance axiom`
...
## 187. `02-tst-core/OUTLINE.md`

**Alternatives proposed:** `OUTLINE.md`

- `OUTLINE.md` — **haiku-4-5:** TST outline; name is standard. Keep.

## 188. `02-tst-core/OUTLINE.md "## Software as Agentic Domain"`
...
**Alternatives proposed:** `Purposeful agent`, `Actuated agent`
...
## 194. `Bretagnolle-Huber identity`
...
## 198. `CLAUDE.md § "What's Settled vs. Open"`
...
## 199. `CLAUDE.md §"What's Settled vs. Open"`
...
## 200. `CLAUDE.md §"Working Conventions"`
...
## 203. `Class 1 / Class 2 / Class 3 agents`
...
## 204. `Continuity persistence`

**Alternatives proposed:** `Identity continuity`
...
## 206. `Control regret ($\delta_{\text{regret}}$)`

**Alternatives proposed:** `Control regret`

- `Control regret` — **gemini-2:** Perfect partner to satisfaction gap. Keep.

## 207. `Convention Hierarchy`

**Alternatives proposed:** `continuation hierarchy`
...
## 208. `Cox's theorem / Causal Hierarchy Theorem / Tikhonov's theorem`
...
## 209. `DA2'-inc ≡ (CT2)-at-M=I equivalence`
...
## 210. `Deliberation cost`

**Alternatives proposed:** `Deliberation cost`, `Deliberation drag`
...
## 212. `Hafez $H_b$ / Miller meta-machine / Bruineberg Pearl-blanket`
...
## 214. `Instance 1/2/3 of #identifiability-floor`
...
## 216. `LOG.md (cycle history document)`
...
## 219. `Logozoetic Agents (Part IV)`

**Alternatives proposed:** `Logozoetic Agents`

- `Logozoetic Agents` — **opus-4-7-b:** Keep.

## 220. `Lohmiller-Slotine contraction (metric generalization used in `#contraction-template`)`
...
## 222. `Monderer-Shapley potential games`
...
## 223. `Monderer-Shapley potential games / Rosen monotone games`
...
## 228. `Pearl's causal hierarchy (L0/L1/L2 in Pearl's own vocabulary)`
...
## 232. `README.md "## Convergent Choices"`

**Alternatives proposed:** `README.md "## Convergent Formulations"`

- `README.md "## Convergent Formulations"` — **codex-1:** Better names what the section is about: representational choices that convergence pressure made non-arbitrary.

## 233. `README.md "## Cross-Domain Joining"`

**Alternatives proposed:** `README.md "## Cross-Domain Mappings"`
...
## 234. `README.md "What This Is"`

**Alternatives proposed:** `README.md "What Agentic Systems Is"`, `README.md "Core Thesis"`

- `README.md "What Agentic Systems Is"` — **codex-1:** The current heading is generic; the framework name should anchor the reader immediately.
- `README.md "What Agentic Systems Is"` — **codex-2:** The current heading is generic in isolation; the framework name should do more first-contact work.
- `README.md "What Agentic Systems Is"` — **opus-4-7:** Current section reads generically; naming the framework in the heading anchors the reader. Minor, opportunistic.
- `README.md "Core Thesis"` — **gemini-2:** "What This Is" is too generic for a dense theoretical framework.

## 235. `Satisfaction gap`

**Alternatives proposed:** `Satisfaction gap`

- `Satisfaction gap` — **gemini-1:** The 2x2 diagnostic with Control regret is perfect. Do not touch.

## 236. `Satisfaction gap ($\delta_{\text{sat}}$)`

**Alternatives proposed:** `Satisfaction gap`

- `Satisfaction gap` — **gemini-2:** Crispest named pair along with control regret. Do not touch.

## 237. `Section I. Adaptive Systems Under Uncertainty`
...
## 238. `Separable core / structured repair / general open`
...
## 245. `Temporal Software Theory (TST)`
...
## 249. `Update gain ($\eta^\ast$)`

**Alternatives proposed:** `Epistemic gain`
...
## 250. `[symbol default: (PI) parameterization-invariance axiom]`
...
## 252. `[symbol default: Sigma_t in prose]`
...
## 253. `[unnamed: "calibration laboratory" framing for software/TST]`
...
## 254. `[unnamed: "inevitability core"]`
...
## 255. `[unnamed: Pearl's causal hierarchy (Level 1 / Level 2 / Level 3)]`
...
## 256. `[unnamed: Terminal alignment error as a formal signal ($\delta_\text{align}$)]`
...
## 257. `[unnamed: coupling between an agent's model-of-self and model-of-other, the prose form of kappa_cross]`
...
## 258. `[unnamed: future segment-layer header for the O-BP14 derivation-audit table]`
...
## 259. `[unnamed: organizing-principle slogan "an adaptive system is a projection whose contraction rate exceeds its target's drift rate"]`
...
## 260. `[unnamed: property of having genuine temporal experience]`
...
## 261. `[unnamed: quality of $\eta^*$ estimation over time]`
...
## 262. `[unnamed: rate of growth at slowest timescale]`
...
## 263. `[unnamed: software as AAD's privileged high-identifiability calibration laboratory]`
...
## 264. `[unnamed: strengthen-first posture]`
...
## 265. `[unnamed: stronger composition-consistency demand that composite admissibility inherit from sub-agent properties plus topology]`
...
## 266. `[unnamed: the "epistemic architecture as AAD's distinctive contribution" frame]`
...
## 267. `[unnamed: the "strengthen before soften" work posture]`
...
## 268. `[unnamed: the "strengthen-first, attempt the improbable" meta-approach to theory development]`
...
## 269. `[unnamed: the #agent-identity commitment that AAD applies on one singular, non-forkable causal trajectory]`
...
## 270. `[unnamed: the chain-layer anchor role in #additive-coordinate-forcing]`
...
## 271. `[unnamed: the condition for transition into agency prior to the AAD scope-condition]`
...
## 272. `[unnamed: the convention hierarchy (C1 / C2 / C3)]`
...
## 273. `[unnamed: the correlation hierarchy (L0 / L1 / L1' / L2)]`
...
## 274. `[unnamed: the per-reader compounding cost of understanding code]`
...
## 275. `[unnamed: the phenomenon where persistence success makes an agent less likely to detect the conditions requiring structural adaptation]`
...
## 276. `[unnamed: the projection whose contraction rate must exceed target drift — the Opus organizing-principle slogan]`
...
## 277. `[unnamed: the region in parameter space where sector-persistence holds]`
...
## 278. `[unnamed: the region where the persistence condition holds]`
...
## 279. `[unnamed: the sector-persistence region in parameter space where the agent is guaranteed to maintain bounded mismatch]`
...
## 280. `[unnamed: variation in correction architectures across a population that is invisible to current persistence analysis]`
...
- ``#uniqueness-coordinates`` — **opus-4-7-b:** Closer to the mechanism ("uniqueness theorem forces coordinate"); loses a little crispness compared to `#forced-coordinates`. Second-choice.
- ``#cauchy-coordinates`` — **opus-4-7-b:** Short, crisp, memorable — but actively misleading now that the Čencov instance is part of the primary four. "Cauchy" undersells the metric-layer instance and risks calcifying the meta-segment in a form it has already grown past. Reject.

## 287. ``#ai-agent-as-act-agent``

**Alternatives proposed:** ``#ai-agent-as-adaptive-agent``, ``#logogenic-agent-mapping``

- ``#ai-agent-as-adaptive-agent`` — **opus-4-7-b:** See slug-relics section above.
...
## 288. ``#ai-agent-as-act-agent` (logogenic)`

**Alternatives proposed:** ``#ai-agent-as-adaptive-agent``

- ``#ai-agent-as-adaptive-agent`` — **opus-4-7-b:** Same argument. Matches `#developer-as-adaptive-agent`; the parallel structure (two domain instantiations of "adaptive agent") is itself a pedagogical payoff.

## 289. ``#atomic-changeset``
...
## 291. ``#composition-consistency``

**Alternatives proposed:** ``#composition-consistency``
...
## 292. ``#critical-mass-composition``

**Alternatives proposed:** ``#critical-mass-composition``
...
## 294. ``#developer-as-act-agent``

**Alternatives proposed:** ``#developer-as-adaptive-agent``, ``#developer-as-aad-agent``
...
## 295. ``#developer-as-act-agent` (TST)`
...
## 296. ``#exploit-explore-deliberate``
...
## 299. ``#loop-interventional-access``
...
- ``#scope-condition`` — **opus-4-7-b:** Keep. This is the Section I membership criterion — "where AAD applies." The slug is self-announcing and gets cited heavily across segments.

## 303. ``#separability-pattern``

**Alternatives proposed:** ``#separability-ladder``, ``#separability-staircase``
...
## 304. ``#symbiogenic-composition``

**Alternatives proposed:** ``#symbiogenic-composition``
...
## 306. ``claims-verified` / `deps-verified` / `format-clean``
...
## 311. `alpha1 (fixed-gain A2' sub-scope)`
...
## 312. `alpha2 (adaptive-gain A2' sub-scope)`
...
## 314. `aporia / prolepsis / aisthesis / epistrophe / praxis`
...
## 316. `calibration laboratory (framing for TST)`
...
## 319. `convention hierarchy (C1/C2/C3)`
...
## 324. `information bottleneck (Tishby)`
...
## 331. `stability-plasticity feasibility window`
...
## 333. `strengthen before softening`

**Alternatives proposed:** `strengthen before softening`, `attempt the improbable`
...
## 334. `strengthen-first-then-soften posture`
...
## 339. `unity dimensions (U_M, U_O, U_Σ)`

**Alternatives proposed:** `unity dimensions`

- `unity dimensions` — **agent1-original-brainstorm:** Three-axis coherence intuition works. Framing nudge in Section III preamble to clarify what unity is measuring — no rename.

## 340. `value object`

**Alternatives proposed:** `policy-conditioned value`
...
## 341. `Čencov / Fisher / Cauchy functional equation / Shore-Johnson / Hobson / Aczél`

**Alternatives proposed:** `*(do not rename)*`

- `*(do not rename)*` — **opus-4-7-b:** External theorems. Keep original names per provenance.

## 342. `Čencov-invariance`
...
**Alternatives proposed:** `Σ_t (strategy)`

- `Σ_t (strategy)` — **haiku-4-5:** "Strategy" is the standard English name. No synonym needed. Keep.

## 345. `α (lower sector bound)`

**Alternatives proposed:** `α (sector parameter)`

- `α (sector parameter)` — **sonnet-4-6:** The symbol is necessary in equations. The English gloss "sector parameter" is correct — NOTATION.md says this already. No change needed in notation. Keep α.
...
## 347. `β (A2' assumed-sector sub-scope)`
...
- `postulated-sector regime` — **haiku-4-5:** Parallel. Keep β as symbol; English equivalent for prose.
...
- `assumed-sector regime` — **agent1-original-brainstorm:** Parallel to α₁/α₂.
...
## 350. `#causal-discovery-from-git`

**Alternatives proposed:** `#causal-discovery-from-git`
...
## 351. `#coupled-update-dynamics`

**Alternatives proposed:** `#coupled-update-dynamics`

- `#coupled-update-dynamics` — **codex-1:** Slightly textbook, but it says exactly what the logogenic section needs and pairs cleanly with directed separation.
- `#coupled-update-dynamics` — **codex-2:** Generic, but faithful; the novelty is in "coupled," not in inventing a flashier noun.

## 352. `#objective-functional`
...
## 353. `Causal information yield (CIY)`

**Alternatives proposed:** `Interventional yield`
...
## 354. `Communication gain ($\eta_{ji}^\ast$)`
...
## 357. `Unity dimensions ($U_M, U_O, U_\Sigma$)`

**Alternatives proposed:** `Coherence dimensions`
...
## 358. `correlation hierarchy (L0/L1/L1'/L2)`

**Alternatives proposed:** `correlation ladder`, `correlation hierarchy`
...
- `processing coupling` — **opus-4-7:** Symbol is fine but the name "κ-as-scalar" was explicitly retired as a category error — the live reading is "processing coupling as a diagnostic for Class 3 agents." Surface that English name consistently.
- `epistemic capacity` — **gemini-2:** Gives a physical intuition to processing bandwidth.
- `processing-coupling coefficient` — **sonnet-4-6:** The symbol appears in #directed-separation where the English name "processing coupling" is used. The coefficient subscript form "κ_processing" is unwieldy in prose. Adding "processing-coupling coefficient" to LEXICON.md's Terms to Be Added section would help.

## 360. `"1-anchor-plus-3-theorem"`
...
## 362. `"Chronica" (capitalized vs lowercase)`
...
## 364. `"Empirical, heuristic, discussion" (third ring)`
...
## 365. `"Gate 1 / Gate 2 / Gate 3 / Gate 4" (FORMAT.md promotion gates)`
...
## 366. `"II. Actuated Adaptation: Agentic Systems"`
...
## 368. `"Promote in topological order"`
...
## 369. `"Track 1" / "Track 2" in #bias-bound-derivation`
...
## 371. `"calibration laboratory framing"`
...
## 374. `"communal-imagination test" (in naming-principles.md)`
...
## 375. `"dark-room critique" citation phrasing (Sun & Firestone)`
...
## 376. `"epistemic architecture for bounded correction under decomposed disturbance"`
...
## 378. `"hierarchy" (as repeated word)`
...
## 380. `"hierarchy" as a project-wide word`
...
## 381. `"mismatch injection rate" (ρ)`

**Alternatives proposed:** `mismatch injection rate`

- `mismatch injection rate` — **sonnet-4-6:** The phrase "environmental change rate" and "mismatch injection rate" are both used for ρ. "Mismatch injection rate" is more precise (it names what ρ does: inject mismatch). NOTATION.md uses "environment change rate." Slight preference for "injection rate" in Discussion sections.

## 382. `"observability dominance"`
...
## 384. `"persistence" (three senses: structural / operational / continuity)`
...
## 385. `"prior-art integration" (convention)`
...
**Alternatives proposed:** `## Scope Limits`

- `## Scope Limits` — **codex-2:** I like the ethos, but the header should optimize scanability over tone.

## 387. `## What Is Derived vs. What Is Chosen`
...
## 388. `## What Is Derived vs. What Is Chosen (derivation-audit table heading)`
...
## 391. `#adversarial-exponent-regimes`

**Alternatives proposed:** `#adversarial-exponent-regimes`

- `#adversarial-exponent-regimes` — **haiku-4-5:** α = 2, 3/2, ~1. Self-descriptive. Keep.

## 392. `#adversarial-tempo-advantage`

**Alternatives proposed:** `#superlinear-tempo-advantage`, `#adversarial-tempo-advantage`
...
## 394. `#atomic-changeset`

**Alternatives proposed:** `#atomic-changeset`

- `#atomic-changeset` — **codex-2:** Good enough and sayable; "atomic" does real work here.

## 395. `#causal-hierarchy-requirement`

**Alternatives proposed:** `#causal-hierarchy-requirement`
...
## 397. `#ciy-observational-proxy`

**Alternatives proposed:** `#ciy-observational-proxy`

- `#ciy-observational-proxy` — **haiku-4-5:** When CIY is estimable from observational data. Compound but accurate. Keep.

## 398. `#composition-scope-condition`

**Alternatives proposed:** `#composite-agent condition`, `#teleological-alignment-condition`, `#composition-scope-condition`
...
## 399. `#coupled-diagnostic-framework`

**Alternatives proposed:** `#post-hoc diagnostics`, `#coupled-diagnostic-pass`

- `#post-hoc diagnostics` — **codex-1:** "Framework" is generic filler here. The distinctive move is diagnostic extraction after the coupled update.
- `#coupled-diagnostic-pass` — **codex-2:** "Framework" is abstract; the segment is really a post-update procedure.

## 400. `#directed-separation-under-composition`

**Alternatives proposed:** `#directed-separation-under-composition`
...
## 402. `#dual-optimization`

**Alternatives proposed:** `comprehension-implementation optimization`, `#dual-cost-optimization`, `#dual-optimization`, `#comprehension-implementation-tradeoff`
...
## 403. `#edge-update-causal-validity`

**Alternatives proposed:** `#edge-update-causal-validity`

- `#edge-update-causal-validity` — **haiku-4-5:** When edge updates are causally valid. Self-descriptive. Keep.

## 404. `#edge-update-natural-parameter`

**Alternatives proposed:** `#edge-update-natural-parameter`
...
## 405. `#edge-update-via-gain`

**Alternatives proposed:** `#edge-update-via-gain`

- `#edge-update-via-gain` — **haiku-4-5:** Gain extends to strategy edges. Self-descriptive. Keep.

## 406. `#event-driven-dynamics`

**Alternatives proposed:** `#event-driven-dynamics`

- `#event-driven-dynamics` — **haiku-4-5:** Events in continuous time. Self-descriptive. Keep.

## 407. `#explicit-strategy-condition`

**Alternatives proposed:** `#deliberation-advantage-condition`, `#explicit-strategy-condition`, `#planning-scope`
...
## 408. `#fisher-whitened-update-rule`

**Alternatives proposed:** `#fisher-whitened-update-rule`, `#fisher-whitened-update`
...
## 409. `#identifiability-floor "escape the floor"`
...
## 410. `#linear-ode-approximation`

**Alternatives proposed:** `#linear-ode-approximation`

- `#linear-ode-approximation` — **haiku-4-5:** Pedagogical linear mismatch ODE. Self-descriptive. Keep.

## 411. `#mismatch-decomposition`

**Alternatives proposed:** `#mismatch-decomposition`

- `#mismatch-decomposition` — **haiku-4-5:** Model error + obs noise. Self-descriptive. Keep.

## 412. `#mismatch-dynamics`

**Alternatives proposed:** `#mismatch-dynamics`

- `#mismatch-dynamics` — **haiku-4-5:** Mismatch evolution ODE. Self-descriptive. Keep.

## 413. `#model-class-fitness`

**Alternatives proposed:** `#model-class-fitness`
...
## 416. `#observability-dominance`

**Alternatives proposed:** `#epistemic-freezing`, `#observability-dominance`
...
## 417. `#observation-gates-advantage`

**Alternatives proposed:** `#observation-gates-advantage`

- `#observation-gates-advantage` — **haiku-4-5:** Obs noise gates advantage. Self-descriptive. Keep.

## 418. `#operationalization`
...
## 419. `#per-dimension-persistence`

**Alternatives proposed:** `#weak-link-persistence`, `#per-dimension-persistence`
...
## 420. `#sector-condition-derivation`
...
## 421. `#sector-condition-stability`

**Alternatives proposed:** `#sector-condition-stability`
...
## 423. `#strategic-calibration`

**Alternatives proposed:** `#strategy-calibration`, `#strategic-calibration`
...
## 424. `#strategic-dynamics-derivation`

**Alternatives proposed:** `#strategic-dynamics-derivation`
...
## 426. `#strategy-complexity-cost`

**Alternatives proposed:** `#strategy-maintenance-cost`, `#strategy-complexity-cost`
...
## 427. `#strategy-cost-regret-bound`

**Alternatives proposed:** `#strategy-cost-regret-bound`
...
## 428. `#strategy-dimension`

**Alternatives proposed:** `#strategy-dimension`, `#strategy-decomposition`
...
## 429. `#strategy-persistence-schema`

**Alternatives proposed:** `#strategic-persistence`, `#strategy-persistence-schema`
...
## 430. `#structural-adaptation-necessity`

**Alternatives proposed:** `#structural-adaptation-necessity`
...
## 431. `#structural-change-as-parametric-limit`

**Alternatives proposed:** `#structural-parametric-limit`, `#structural-change-as-parametric-limit`
...
## 432. `#system-coherence`

**Alternatives proposed:** `change coherence`
...
**Alternatives proposed:** `#system-coupling`
...
## 434. `#tempo-composition`

**Alternatives proposed:** `#composite-tempo`, `#tempo-composition`
...
## 435. `#temporal-nesting`

**Alternatives proposed:** `#temporal-nesting`
...
**Alternatives proposed:** `#coherence-closure-mapping`, `#unity-closure-mapping`
...
## 442. `$C$ (bias-bound constant in `#bias-bound-derivation`)`
...
## 443. `$U_M$ / $U_O$ / $U_\Sigma$ (unity dimensions)`
...
## 444. `$U_o$ / $U_M$ (observation uncertainty / model uncertainty)`
...
## 445. `$\alpha, \beta$ (sector-lower and A2'-sub-scope)`
...
## 446. `$\kappa_{\text{processing}}$ (Class-2 processing coupling)`
...
## 447. `$\mathcal C_t^{\text{commit}}$ (TST committed-state subset)`
...
## 448. `$\mathcal C_t^{\text{commit}}$ (committed-state subset)`
...
## 449. `$\rho$ (environment change rate / mismatch injection rate)`
...
## 450. `$\rho_\Sigma$ (strategic disturbance rate)`

**Alternatives proposed:** `$\rho_\Sigma$`

- `$\rho_\Sigma$` — **opus-4-7-b:** Keep. Subscript is load-bearing.

## 451. `$f_M$ (Event-driven update)`
...
## 452. `$f_{\text{init}}$ (Reconstruction function)`
...
## 453. `$g_M$ (Between-event evolution)`
...
## 454. `(PI) parameterization-invariance`
...
## 455. `(R1), (R2) — Result numbering convention in logogenic-agents`
...
## 456. `Agentic Systems Framework (ASF, top-level)`
...
## 458. `CLAUDE.md § "Working Conventions"`
...
## 463. `L1' (correlation-hierarchy prime-decoration)`
...
## 469. `README.md "## Maturity Gradient"`

**Alternatives proposed:** `README.md "## Theory Maturity Gradient"`
...
## 470. `README.md "Convergent Choices"`

**Alternatives proposed:** `README.md "Forced-by-Failure Choices"`
...
## 471. `README.md "Maturity Gradient"`

**Alternatives proposed:** `README.md "Maturity Gradient"`

- `README.md "Maturity Gradient"` — **opus-4-7:** Fine. Keep.

## 472. `README.md "Novel Results"`
...
## 473. `README.md "Structure"`

**Alternatives proposed:** `README.md "Theory Architecture"`
...
## 474. `README.md § "Convergent Choices"`

**Alternatives proposed:** `README.md § "Convergent Choices"`
...
## 475. `README.md § "Cross-Domain Joining"`
...
## 479. `README.md § "Structure"`

**Alternatives proposed:** `README.md § "Structure"`

- `README.md § "Structure"` — **opus-4-7-b:** Keep.

## 480. `Section II. Actuated Adaptation: Agentic Systems`
...
## 481. `Sector condition`

**Alternatives proposed:** `Persistence condition`, `Correction sector`
...
## 484. `TODO.md "§Active — Pending-Review Spikes"`
...
## 487. `U_M, U_O, U_Σ (unity dimensions)`
...
## 491. `[future segment: information-theoretic cost floor for persistence]`
...
## 492. `[symbol default: G_t in prose]`
...
## 493. `[symbol default: M_t in prose]`
...
## 494. `[symbol default: bias-bound Track 1 / Track 2]`
...
## 496. `[unnamed: "scope-honesty-as-architecture"]`

**Alternatives proposed:** `scope honesty`

- `scope honesty` — **opus-4-7:** Already used as a term; "-as-architecture" is the argumentative form. "Scope honesty" alone works as the noun for the commitment (as it already does in several segments).

## 497. `[unnamed: Class 1 / Class 2 / Class 3 agent classes themselves — need mnemonic handles]`
...
## 498. `[unnamed: Joseph's mental model "projection whose contraction rate must exceed its target's drift rate"]`
...
## 499. `[unnamed: The cycle-as-a-whole]`

**Alternatives proposed:** `adaptive traversal`

- `adaptive traversal` — **gemini-2:** "The cycle-as-a-whole" is clunky. "Adaptive traversal" suggests moving through the loop.

## 500. `[unnamed: agent as a projection whose contraction rate must exceed its target's drift]`
...
## 501. `[unnamed: calibration-laboratory framing as reusable meta-move]`
...
## 502. `[unnamed: cascade of inferential force strengthening from C1 to C3 on satisfaction-gap / control-regret diagnostics]`

**Alternatives proposed:** `inferential cascade`

- `inferential cascade` — **opus-1m:** Agree with original. Low priority.

## 503. `[unnamed: cascade of inferential force through C1/C2/C3]`
...
## 504. `[unnamed: chain-layer anchor role in #additive-coordinate-forcing]`

**Alternatives proposed:** `chain anchor`

- `chain anchor` — **agent1-original-brainstorm:** Prose term, not segment rename. Lets three theorem-analogs refer back naturally.

## 505. `[unnamed: complexity-driven resistance to change as features accumulate]`
...
## 506. `[unnamed: convention-hierarchy monotonicity cascade / satisfaction-gap-and-control-regret strengthening across C1→C3]`

**Alternatives proposed:** `inferential force cascade`

- `inferential force cascade` — **agent1-original-brainstorm:** Low priority but worth noting. Pedagogical.

## 507. `[unnamed: cycle-phase sequence as a whole]`
...
## 508. `[unnamed: cycle-phase sequence as whole]`
...
## 509. `[unnamed: decomposing mismatch into environment vs. other sub-agents' actions]`
...
## 510. `[unnamed: effort/time/risk-ranking considered "false constraints"]`
...
## 511. `[unnamed: empty stability-plasticity feasibility window in #consolidation-dynamics]`
...
## 512. `[unnamed: epochal stability → latent diversification → niche emergence...]`
...
## 513. `[unnamed: externalizing part of M_t into the environment for future agents]`
...
## 514. `[unnamed: fourth diagnostic where terminal conditions are met but the objective is still missed]`
...
## 515. `[unnamed: future segment-layer header for narrative/pedagogical framing]`

**Alternatives proposed:** `## Narrative Framing`

- `## Narrative Framing` — **opus-1m:** Parallel reservation. For ELI10 / pedagogical outlines.

## 516. `[unnamed: future segment-layer header for the SP-5 Reader's Path proposal]`
...
## 517. `[unnamed: git-recorded committed-state subset of the chronica, C_t^{commit}]`
...
## 518. `[unnamed: minimum sufficiency required after a session rebuild]`
...
## 519. `[unnamed: the "1-anchor + 3-theorem" structure itself]`
...
## 520. `[unnamed: the "functional requirements are the results; formalisms are the engineering" slogan]`
...
## 521. `[unnamed: the "scope-honesty-as-architecture" working principle]`

**Alternatives proposed:** `scope honesty / scope honesty as architecture`

- `scope honesty / scope honesty as architecture` — **opus-4-7-b:** Already named in CLAUDE.md §7(a) as "scope-honesty-as-architecture." The phrase is workable; the shorter "scope honesty" does most of the prose work. Usage observation: use the short form in prose, the hyphenated form in CLAUDE.md-register discussions of the element itself.

## 522. `[unnamed: the "strengthen-before-soften" posture applied to apparent overclaims]`
...
## 523. `[unnamed: the 1-anchor + 3-theorem structure in #additive-coordinate-forcing]`
...
## 524. `[unnamed: the 1-anchor-plus-3-theorem characterization]`
...
## 525. `[unnamed: the 1-anchor-plus-3-theorem structure]`
...
## 526. `[unnamed: the 2×2 satisfaction-gap / control-regret table]`
...
## 527. `[unnamed: the 2×2 satisfaction-gap × control-regret diagnostic table]`
...
## 528. `[unnamed: the A2' sub-scope partition collectively]`
...
## 529. `[unnamed: the AAD-expressible failure mode of an empty stability-plasticity window]`
...
## 530. `[unnamed: the Class-1-sub-agents -> Class-3-composite phenomenon in strategic composition]`
...
## 531. `[unnamed: the architectural-class partition Class 1 / Class 2 / Class 3]`
...
## 532. `[unnamed: the calibration-laboratory concept applied outside TST]`
...
## 533. `[unnamed: the chain-confidence-decay mathematical anchor as the 1 in "1-anchor + 3-theorem"]`
...
## 534. `[unnamed: the condition that the agent's event-observation pairs constitute genuine interventions as opposed to passive associations]`
...
## 535. `[unnamed: the contraction-over-drift insight]`
...
## 536. `[unnamed: the cycle-as-a-whole]`

**Alternatives proposed:** `the adaptive pentad`, `the five-turn`
...
## 537. `[unnamed: the derivation/formulation/hypothesis/... status gradient in FORMAT.md]`
...
## 538. `[unnamed: the externalization-reconstruction cycle across sessions]`

**Alternatives proposed:** `memory relay`

- `memory relay` — **codex-2:** Short, sayable noun for a repeated logogenic mechanism.

## 539. `[unnamed: the invisible time spent building M_t]`
...
## 540. `[unnamed: the iterated-audit process (Gemini / Opus / Codex de novo, consolidated, three-doc portfolio)]`
...
## 541. `[unnamed: the meta-architecture of #separability-pattern + #identifiability-floor + #additive-coordinate-forcing]`
...
## 542. `[unnamed: the organizing-principle slogan — "An adaptive system is a projection whose contraction rate exceeds its target's drift rate"]`
...
## 543. `[unnamed: the pattern where AAD's negative results (floors) strengthen the machinery that escapes them]`
...
## 544. `[unnamed: the phenomenon that unobservable edges freeze and paths become epistemically dead]`
...
## 545. `[unnamed: the procedure of reading any segment through all three meta-segments]`
...
## 546. `[unnamed: the sector-persistence region in parameter space]`
...
## 547. `[unnamed: the self-reinforcing code-quality → tempo loop]`
...
## 548. `[unnamed: the set of five conditions under which A2' is derived rather than assumed — the sub-scope-α agent classes]`
...
## 549. `[unnamed: the signed-coupling structure across all Section III results]`
...
## 550. `[unnamed: the strengthen-first *attempt* artifact — a spike that tried to derive something stronger and failed]`
...
## 551. `[unnamed: the template family — sector-persistence + contraction + possible future dissipativity]`
...
## 552. `[unnamed: the three concentric rings of segment content — inevitability core / canonical formulations / empirical-heuristic]`
...
## 553. `[unnamed: the three-rings-of-segment-content framing]`
...
## 554. `[unnamed: the virtuous/vicious cycle between M_t quality and Sigma_t evaluable complexity]`
...
## 555. `[unnamed: variation in correction architectures invisible to persistence analysis]`

**Alternatives proposed:** `latent structural diversity`

- `latent structural diversity` — **gemini-2:** Proposed in the gap section of OUTLINE.md. Captures the concept perfectly.

## 556. `[working-vocabulary observation: the framework's honesty is load-bearing]`
...
## 557. ``### What Is Derived vs. What Is Chosen` (derivation-audit table)`
...
## 560. ``#adversarial-edge-targeting``
...
## 561. ``#adversarial-tempo-advantage``

**Alternatives proposed:** ``#adversarial-tempo-advantage``

- ``#adversarial-tempo-advantage`` — **opus-4-7-b:** Keep. Descriptive, direct, doesn't need to be shorter.

## 562. ``#agent-environment``
...
**Alternatives proposed:** ``#agent-spectrum``
...
## 565. ``#ai-specification-limit` (as TST concept, currently only in old-tst files)`

**Alternatives proposed:** ``#ai-specification-limit``

- ``#ai-specification-limit`` — **opus-4-7-b:** Keep reserved slot. Eventually promotes from old-tst files.
...
## 567. ``#approximation-tiering``

**Alternatives proposed:** ``#approximation-tiering``

- ``#approximation-tiering`` — **opus-4-7-b:** Keep. Already avoids the "hierarchy" overload; "tiering" is the right word.

## 568. ``#bias-bound-derivation``

**Alternatives proposed:** ``#class-2-bias-bound``
...
## 569. ``#causal-hierarchy-requirement``
...
## 570. ``#causal-information-yield` (CIY)`

**Alternatives proposed:** ``#causal-information-yield``

- ``#causal-information-yield`` — **opus-4-7-b:** Keep. The CIY acronym is useful and the slug is self-contained.

## 571. ``#causal-insufficiency-detection``

**Alternatives proposed:** ``#latent-cause-detection``, ``#causal-insufficiency-detection``
...
## 572. ``#change-distance` / `#change-proximity-principle``
...
## 573. ``#changeset-size-principle``

**Alternatives proposed:** ``#changeset-size-principle``

- ``#changeset-size-principle`` — **opus-4-7-b:** Keep. Principle-level claim; named descriptively.

## 574. ``#code-quality-as-observation-infrastructure``

**Alternatives proposed:** ``#code-quality-as-observation-infrastructure``
...
## 577. ``#composition-scope-condition``

**Alternatives proposed:** ``#composition-scope-condition``

- ``#composition-scope-condition`` — **opus-4-7-b:** Keep. Honest, direct.

## 578. ``#comprehension-time` / `#implementation-time``

**Alternatives proposed:** `keep both`

- `keep both` — **opus-4-7-b:** Keep. Canonical TST quantities.

## 579. ``#compression-operations``

**Alternatives proposed:** ``#compression-operations``

- ``#compression-operations`` — **opus-4-7-b:** Keep. Plural "operations" correctly signals this is a family ($M_t$, $G_t^{\text{shared}}$, $\Sigma_t$, $\Lambda$).

## 580. ``#conceptual-alignment``

**Alternatives proposed:** ``#conceptual-alignment``

- ``#conceptual-alignment`` — **opus-4-7-b:** Keep. Core TST empirical claim; slug is clear.

## 581. ``#consolidation-dynamics``

**Alternatives proposed:** ``#consolidation-dynamics``

- ``#consolidation-dynamics`` — **opus-4-7-b:** Keep. "Consolidation" imports the neuroscience baggage (memory consolidation, stability-plasticity) that's precisely what the segment is formalizing.
...
## 585. ``#deliberation-cost``

**Alternatives proposed:** ``#deliberation-cost``

- ``#deliberation-cost`` — **opus-4-7-b:** Keep. "Cost" signals tradeoff cleanly.

## 586. ``#directed-separation-under-composition``

**Alternatives proposed:** ``#composite-directed-separation``
...
## 587. ``#discrete-sector-condition``

**Alternatives proposed:** ``#discrete-sector-condition``

- ``#discrete-sector-condition`` — **opus-4-7-b:** Keep. Direct analog of `#sector-condition-stability` for discrete time.

## 588. ``#dual-optimization``

**Alternatives proposed:** ``#dual-optimization``

- ``#dual-optimization`` — **opus-4-7-b:** Keep.

## 589. ``#edge-update-natural-parameter``

**Alternatives proposed:** ``#log-odds-update``
...
## 591. ``#event-driven-dynamics``

**Alternatives proposed:** ``#event-driven-dynamics``

- ``#event-driven-dynamics`` — **opus-4-7-b:** Keep. "Event-driven" carries correct engineering baggage (versus turn-based / synchronous).

## 592. ``#exponential-cognitive-load``
...
## 593. ``#fisher-whitened-update-rule``

**Alternatives proposed:** ``#fisher-whitened-update-rule``
...
## 594. ``#gain-sector-bridge` / `#gain-sector-derivation``
...
## 595. ``#graph-structure-uniqueness``

**Alternatives proposed:** ``#strategy-dag-uniqueness``
...
## 597. ``#interaction-channel-classification``

**Alternatives proposed:** ``#recipient-regime-classification``, ``#interaction-channel-classification``
...
- ``#l1-update-bias`` — **opus-4-7-b:** Keep. "L1" is AAD's own correlation-hierarchy label; the slug is self-locating. If the correlation-hierarchy rename to `#correlation-ladder` lands, revisit (the "L1" abbreviation survives, so no cascade).

## 599. ``#linear-ode-approximation``
...
## 600. ``#mismatch-decomposition``

**Alternatives proposed:** ``#mismatch-decomposition``

- ``#mismatch-decomposition`` — **opus-4-7-b:** Keep. Direct.

## 601. ``#mismatch-dynamics``

**Alternatives proposed:** ``#mismatch-dynamics``

- ``#mismatch-dynamics`` — **opus-4-7-b:** Keep.

## 602. ``#model-sufficiency` / `#model-class-fitness``
...
## 604. ``#observation-function` / `#action-transition``

**Alternatives proposed:** `keep`

- `keep` — **opus-4-7-b:** Keep both. Short, direct, describe what they are.

## 605. ``#per-dimension-persistence``

**Alternatives proposed:** ``#weakest-link-persistence``
...
## 606. ``#persistence-cost``

**Alternatives proposed:** ``#persistence-cost``

- ``#persistence-cost`` — **opus-4-7-b:** Keep. Short, accurate (information-rate *cost* to maintain the persistence bound).

## 607. ``#principled-decision-integration``

**Alternatives proposed:** ``#principled-decision-integration``

- ``#principled-decision-integration`` — **opus-4-7-b:** Keep.

## 608. ``#recursive-update-derivation` / `#gain-sector-derivation``
...
## 609. ``#sector-condition-stability``

**Alternatives proposed:** ``#sector-condition-stability``

- ``#sector-condition-stability`` — **opus-4-7-b:** Keep.

## 610. ``#sector-persistence-template``

**Alternatives proposed:** ``#sector-persistence-template``
...
## 611. ``#software-epistemic-properties``

**Alternatives proposed:** ``#software-epistemic-properties``

- ``#software-epistemic-properties`` — **opus-4-7-b:** Keep. "Software" locates the domain; "epistemic properties" lines up with AAD §7's epistemic-architecture framing.
...
**Alternatives proposed:** ``#strategy-edge-dynamics``
...
## 615. ``#strategy-persistence-schema``

**Alternatives proposed:** ``#strategy-persistence-schema``
...
## 616. ``#structural-adaptation-necessity``
...
## 617. ``#system-coherence` / `#system-coupling` / `#system-availability``
...
## 620. ``#unity-closure-mapping``

**Alternatives proposed:** ``#unity-closure-mapping``
...
## 621. ``#variational-sector-condition``

**Alternatives proposed:** ``#variational-sector-condition``

- ``#variational-sector-condition`` — **opus-4-7-b:** Keep.

## 622. ``MIGRATION-MAP.md``
...
## 624. ``spikes/INDEX.md` (spike index)`

**Alternatives proposed:** ``spikes/INDEX.md``

- ``spikes/INDEX.md`` — **opus-4-7-b:** Keep. All-caps index convention.

## 625. ``msc/architectural-proposals-{YYYY-MM-DD}.md``
...
## 626. ``audits/pending-findings-{YYYY-MM-DD}.md``
...
## 628. ``spikes/spike-{topic}-{YYYY-MM-DD}.md``
...
**Alternatives proposed:** `goal-actuated agent`
...
## 636. `calibration-laboratory domain instantiation`
...
## 640. `code quality as observation infrastructure`

**Alternatives proposed:** `observation infrastructure`
...
## 641. `composition closure / closure defect ($\varepsilon^\ast$)`
...
## 642. `coordination overhead threshold`
...
## 644. `distributed tempo`

**Alternatives proposed:** `network tempo`
...
## 646. `logozoetic agent`

**Alternatives proposed:** `logozoetic agent`
...
## 650. `privileged high-identifiability calibration laboratory`
...
## 651. `separable core / structured repair / general open`
...
## 652. `strategic composite`

**Alternatives proposed:** `equilibrium composite`
...
## 654. `three-part meta-architecture`
...
## 655. `α₁ / α₂ / β naming as a whole`

**Alternatives proposed:** `α-partition (with English labels above)`

- `α-partition (with English labels above)` — **opus-4-7:** Keep the Greek symbols as shorthand tokens once defined; insist on English equivalents in every new prose usage. Bubble this into FORMAT.md as a convention.

## 656. `α₂ (A2' adaptive-gain sub-scope under (MG-1)–(MG-4))`

**Alternatives proposed:** `adaptive-gain regime`

- `adaptive-gain regime` — **opus-4-7-b:** Same argument. "AMSGrad is an α₂ result" reads terribly; "AMSGrad is an adaptive-gain result" lands.

## 657. `β (A2' assumed sub-scope)`
...
- `verified-externally regime` — **sonnet-4-6:** Too wordy and only half-true (some β agents can verify per-domain). "Assumed" is better.

## 658. `β (A2' assumed-not-derived sub-scope)`

**Alternatives proposed:** `assumed-regime`

- `assumed-regime` — **opus-4-7:** Parallel again; currently reads as "lands in β" which tells the reader nothing. Alternatively "posited-regime."

## 659. `β (A2' assumption tier)`

**Alternatives proposed:** `assumed regime`

- `assumed regime` — **codex-2:** "Beta" is semantically empty in prose; the English gloss clarifies what kind of tier it is.

## 660. `β (A2' sub-scope where A2' is assumed, not derived)`
...
**Alternatives proposed:** `dynamic-gain boundary`

- `dynamic-gain boundary` — **gemini-2:** Gives a conceptual name to the remaining partition.

## 662. `ε*`

**Alternatives proposed:** `minimal closure defect`

- `minimal closure defect` — **gemini-2:** Clarifies that it's the *minimum* achievable.

## 663. `η* (optimal update gain)`

**Alternatives proposed:** `update gain`

- `update gain` — **opus-4-7-b:** See keep above. Prose: "update gain" in running text; η* only in formal expressions.
...
## 665. `ρ_Σ (strategic disturbance rate)`

**Alternatives proposed:** `strategic disturbance rate`
...
## 668. `A2' (operator-sector condition under fidelity-degraded updates)`
...
## 670. `AAD (alternatives considered for completeness)`
...
## 671. `CLAUDE.md § "Key Architectural Decisions"`
...
**Alternatives proposed:** `Linguistic agent`
...
## 675. `Logozoetic agent`

**Alternatives proposed:** `Sentient agent`

- `Sentient agent` — **gemini-1:** Logozoetic avoids the immense baggage and ambiguity of "sentient". Keep Logozoetic.

## 676. `README.md § "What This Is"`

**Alternatives proposed:** `README.md § "What AAD Is"`
...
## 677. `[unnamed: the 2×2 table of satisfaction gap vs. control regret × goal-attainability diagnostic]`
...
## 678. `[unnamed: the meta-architecture of the three meta-segments]`
...
## 679. `[unnamed: the pattern where the agent's optimal update direction is determined by both gain and directional fidelity together]`
...
## 680. `[unnamed: the persistence envelope]`
...
## 681. `[unnamed: the property that correction dynamics are approximately isotropic]`
...
## 682. `[unnamed: the three-part meta-pattern structure across the three meta-segments]`
...
## 683. ``#auftragstaktik-principle``

**Alternatives proposed:** ``#auftragstaktik` (drop "principle")`
...
## 684. ``#strategy-dimension``

**Alternatives proposed:** ``#strategy-dimension``
...
## 685. ``#structural-change-as-parametric-limit``

**Alternatives proposed:** ``#structural-change-as-parametric-limit``
...
## 690. `unity dimensions`

**Alternatives proposed:** `coherence dimensions`

- `coherence dimensions` — **opus-4-7-b:** Considered renaming the *concept* from "unity" to "coherence." Reject: *coherence* is already used informally elsewhere (strategic coherence, epistemic coherence) and a rename would bleed. *Unity* is narrower and actually works once each dimension is named per above.
