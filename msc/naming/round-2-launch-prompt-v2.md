...
- [ ] **5. Orient to the rest of the top-level files and OUTLINEs as appropriate.** [`CLAUDE.md`](../../CLAUDE.md), [`OUTLINE.md`](../../OUTLINE.md), [`PRACTICA.md`](../../PRACTICA.md), [`NOTATION.md`](../../NOTATION.md), [`LEXICON.md`](../../LEXICON.md), [`FORMAT.md`](../../FORMAT.md), and the per-component outlines ([`01-aat-core/OUTLINE.md`](../../01-aat-core/OUTLINE.md), [`02-tst-core/OUTLINE.md`](../../02-tst-core/OUTLINE.md), [`03-llm-core/OUTLINE.md`](../../03-llm-core/OUTLINE.md), [`04-eli-core/OUTLINE.md`](../../04-eli-core/OUTLINE.md)). Sample what helps; don't try to read everything.
...
- [ ] **14. Write your closing observations** in your card's "Cold-start observations" / "Process notes" section at the bottom — anything cycle-level worth surfacing for the round design (per [`doc/sop/naming.sop/methodology.sop.md`](../../doc/sop/naming.sop/methodology.sop.md) §6). Targets where the framing felt off, terms whose defining segment didn't match the card's framing, gaps in the candidate set, observations about the rhythm itself — all in scope.
