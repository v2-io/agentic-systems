...
- [ ] **5. Orient to the rest of the top-level files and OUTLINEs as appropriate.** [`CLAUDE.md`](../../CLAUDE.md), [`OUTLINE.md`](../../OUTLINE.md), [`PRACTICA.md`](../../PRACTICA.md), [`NOTATION.md`](../../NOTATION.md), [`LEXICON.md`](../../LEXICON.md), [`FORMAT.md`](../../FORMAT.md), and the per-component outlines ([`01-aat-core/OUTLINE.md`](../../01-aat-core/OUTLINE.md), [`02-tst-core/OUTLINE.md`](../../02-tst-core/OUTLINE.md), [`03-logogenic-agents/OUTLINE.md`](../../03-logogenic-agents/OUTLINE.md), [`04-eli/OUTLINE.md`](../../04-eli/OUTLINE.md)). Sample what helps; don't try to read everything.
