# Naming Principles — Multi-Agent Vote Instructions (refined edition) [SUPERSEDED for principles content; preserved for voting mechanics]

> **Status (2026-05-08):** This file's *principles* content has been promoted to
> [`doc/naming-principles.md`](../../doc/naming-principles.md) as the long-lived
> source. This copy is preserved for the *voting-mechanics* content — cold-start
> instruction, vote-weight scales, Round-1 / Round-2 deliverable formats, example
> votes, "what to return" — which any in-flight or legacy voting work still
> references. **To be deprecated entirely when the naming cycle's voting
> apparatus is no longer in active use.** Below this header the file is preserved
> verbatim from its 2026-05-04 (refined edition) state.
>
> For long-lived principles (architectural invariants, evaluation criteria,
> decision categories, naming layers, acronym discipline, meta-principle), read
> the doc/ version — it carries the route (d) adopt-as-standard extension that
