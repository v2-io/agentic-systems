...
3.  **03-llm-core**: LLM-based agents. Crucially, these are "Class 2" agents where directed separation fails because language models process observations and goals through the same coupled mechanism. Focuses on what AAD results survive or degrade in this coupled regime.
4.  **04-eli-core**: Highly speculative future work regarding agents with moral continuity, theory of mind, and identity persistence.
...
*   **03-llm-core**: I predict this will heavily feature ambiguity and bias bounds, detailing how the lack of directed separation creates intrinsic limits on LLM agent reasoning or correction speed.
*   **04-eli-core**: I predict this will be mostly philosophical, defining preconditions for identity (like cryptographic exteriorization of the chronica) without tight mathematical proofs yet.
