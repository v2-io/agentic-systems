...
| α₁ (A2' fixed-gain sub-scope) | derived-gain regime | +1 | In prose, "α₁ regime" is hard to distinguish from "a₁ regime" when read aloud. English equivalent "derived-gain regime" emphasizes that A2' is derived under directional fidelity. Would keep Greek symbols in formal segments and NOTATION; add English equivalent to LEXICON for prose fluency. Prose-accessibility enhancement, not a symbol rename. |
| α₂ (A2' adaptive-gain sub-scope) | adaptive-gain regime | +1 | Parallel to α₁ English equivalent. Already used informally. LEXICON entry would formalize. |
| β (A2' assumed-sector sub-scope) | postulated-sector regime | +1 | Parallel. Keep β as symbol; English equivalent for prose. |
...
| Δρ* (adaptive reserve) | adaptive reserve | +3 | The English name "adaptive reserve" is already central to LEXICON and should be kept prominent. Shock tolerance; how much disturbance increase before persistence fails. Evocative and operationally meaningful. Keep. |
...
| closure defect (ε*) | closure defect | +1 | Minimum achievable approximation error for a composite agent. Already named in LEXICON. Acceptable. Keep. |
...
| V_Ot^min | satisfaction threshold | +1 | NOTATION defines this but no English equivalent exists in LEXICON. "Satisfaction threshold" (the minimum trajectory value that counts as objective met) would be useful in prose. Add to LEXICON without renaming the symbol. |
...
| Σ_t (strategy) | Σ_t (strategy) | +3 | "Strategy" is the standard English name. No synonym needed. Keep. |
