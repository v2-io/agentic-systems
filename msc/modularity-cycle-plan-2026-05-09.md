...
- **Multi-timescale stability promotion** — `#der-multi-timescale-stability` from sketch to derived via template-stacking + Tikhonov + Chen-Goldenfeld-Oono. Highest-leverage standalone piece for Section III.
