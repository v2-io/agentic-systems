...
- **OR-node sector condition.** All verified cases use AND-nodes. OR-nodes have different propagation formulas and may have different sector-condition properties.
