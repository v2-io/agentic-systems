...
| Composition consistency (#composition-consistency) | Multi-scale renormalization in physics-flavored FEP work (Friston 2019); approximate | **Partial** | Both want scale-invariant results. AAD requires scope-condition level-independence; AI's multi-scale work is informal and contested (Aguilera et al. 2022). |
...
| Agent identity (#agent-identity) | Markov blanket as identity / "particular partition" in Friston 2019 | **Divergent** | AAD: identity grounded in singular causal trajectory $\mathcal C_t$, not in $M_t$. AI: identity collocated with the Markov blanket / particular partition. The Bruineberg critique applies. |
