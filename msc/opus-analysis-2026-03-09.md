...
Section II of the contents is where AAD differentiates from TFT, and it's also where the most gaps cluster (7 explicit "Gap" entries). This is honest, but I want to name what I think the *root* difficulty is, because I don't think it's any of the individual gaps listed:
