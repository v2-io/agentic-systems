...
3. **The recursive structure** ( #der-recursive-update) — each state depends on the prior state and the new event, enabling all of AAD's recursive-update machinery
