...
term: cursory
name: Cursory
brief: "A search log depth tier: a brief initial search has been performed — enough to check for obvious priors, not enough for confident novelty claims."
...
see_also: [search-log-field, not-conducted, targeted, intuition-only]
aliases: []
