...
brief: Constructive procedure for making a Class-2 or Class-3 component participate as Class-1 in AAD by embedding it in an external scaffold whose type signatures enforce directed separation.
layer: prose-symbol
status: canon
