...
source_type: asf
primary_source: 01-aad-core/src/scope-multi-agent.md
first_asf_mention: 01-aad-core/src/scope-multi-agent.md
...
Defined in [`#scope-multi-agent`](../../01-aad-core/src/scope-multi-agent.md).
