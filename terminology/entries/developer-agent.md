...
The TST domain instantiation of the AAD agent formalism. A developer is an actuated adaptive
...
**The privileged calibration laboratory**: software development is AAD's high-identifiability
...
causal DAG is partially declared (imports, type dependencies). Other AAD domains require
