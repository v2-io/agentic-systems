...
brief: AAD-distinctive decomposition of recipient-side effective disturbance rate by regime — Informative (negative), magnitude-shock, structural-shock, ambient-noise — with three independent boundaries in AAD-native quantities.
layer: prose-symbol
status: canon
...
do_not_confuse:
  - "effective disturbance (bare control-theory term — robust control, disturbance-rejection literature; AAD-generic, not the regime-typed decomposition)"
internal_note: F1 batch citability fix (2026-05-04). Bare 'effective disturbance' is heavy in robust-control / disturbance-rejection literature; the 'regime-typed' qualifier names the AAD-distinctive content (regime decomposition with signed Regime-I term).
---
...
- **Regime I** (Informative): events that contribute *negatively* to $\rho_B^{\text{eff}}$ — cooperative events, well-calibrated signals, learning opportunities. The sign-flip from the standard control-theory positive-only "effective disturbance" framing is the key AAD-distinctive content.
