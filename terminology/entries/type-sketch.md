...
schema_version: 1
term: type-sketch
name: Sketch (segment type)
brief: "A segment type: direction identified, formal rigor pending — the approach is outlined but not completed."
...
see_also: [proposed-schema, hypothesis, status-sketch]
aliases: [sketch]
