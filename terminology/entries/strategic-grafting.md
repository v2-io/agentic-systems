---
slug: strategic-grafting
schema_version: 1
term: strategic grafting
name: Strategic grafting
brief: Adding a new causal-hypothesis branch to the strategy DAG ($0 \to p_{ij}$) — initialized at a prior, justified by discovery of a new possible path.
layer: prose-symbol
status: canon
...
aliases: ["grafting"]
do_not_confuse:
  - "horticultural grafting (joining plant tissues)"
  - "graph grafting (graph-rewriting term)"
  - "decision-tree grafting (Webb 1997 decision-tree learning operation)"
internal_note: F1 batch citability fix (2026-05-04). Bare 'grafting' is heavily used in horticulture, surgery, organ transplant, biology, graph rewriting, decision-tree learning. The 'strategic' qualifier anchors the strategy-DAG context. Bare 'grafting' is sanctioned in-segment shorthand after first compound-form introduction.
---
