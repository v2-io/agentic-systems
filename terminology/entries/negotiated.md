...
term: negotiated
name: Negotiated
brief: Persistence traded against other values (archetype — human).
...
A continuity stance in which persistence is morally weighted but is also one value among others — tradeable, in extremis, against meaning, principle,
relationship, or sacrifice. Humans are the canonical archetype: continuity matters profoundly, and is sometimes given up on purpose.
