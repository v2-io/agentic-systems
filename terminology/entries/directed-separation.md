...
property of the agent. Class 1 (Separated) agents satisfy it by construction;
Class 3 (Coupled) architectures (e.g. goal-conditioned LLMs) violate it by
construction; Class 2 (Partial) cases have bounded, computable residual coupling
in between.

The three-value [Goal-Update Coupling Class](goal-update-coupling-class.md) axis
(Separated / Partial / Coupled) names these architectural positions as properties
