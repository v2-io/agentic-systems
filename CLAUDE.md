...
- **`01-aad-core/`** — **Adaptation and Actuation Theory (AAT)**: the mathematical core. Sections I (Adaptive Systems — the *adaptation* half), II (Actuated Agents — the *actuation* half), III (Composition), plus Appendices.
...
**Components:**
- `01-aad-core/OUTLINE.md` — **AAT canonical outline.** Sections I, II, III + Appendices.
- `01-aad-core/src/` — **AAT segments.** Named by slug. No numbering.
