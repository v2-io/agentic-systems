...
- `1*  ` `README-auditor.md` **(required)**
- `2*  ` `doc/naming-principles.md` **(required)**
- `3*  ` `doc/naming-cycle-methodology.md` **(required)**
- `4*  ` `OUTLINE.md` **(required)**
- `5*  ` `01-aad-core/OUTLINE.md` **(required)**
- `6*  ` `02-tst-core/OUTLINE.md` **(required)**
- `7*  ` `03-logogenic-agents/OUTLINE.md` **(required)**
- `8*  ` `04-logozoetic-agents/OUTLINE.md` **(required)**
- `+*  ` `LEXICON.md` **(required)**
- `+*  ` `NOTATION.md` **(required)**
- `+*  ` `CLAUDE.md` **(required)**
- `+*  ` `FORMAT.md` **(required)**
- `+   ` `MIGRATION-MAP.md` (available)
- `+*  ` `PRACTICA.md` **(required)**
- `+*  ` `doc/de-novo-audit-instructions.md` **(required)**
