...
**Quantitative content from the two-edge case.** The analysis in `msc/spike-two-edge-strategic-dynamics.md` instantiates this result for the minimal multi-edge chain $A \to B \to G$, giving the qualitative claims above precise mathematical form.
