...
- This example does not exercise strategy-level tempo ( #strategy-persistence-schema) or the three-way action-deliberation-exploration tradeoff — both are open questions in ACT. A future worked example targeting these quantities would need a system with genuine deliberation costs.
