...
The necessity of the reinjection channel that the D1 defenses (MEMORATA persistence, GCM consolidation, the durable-artifact and curated-narrative layers) instantiate is the §03.II across-turnover no-go ( #der-turnover-information-recursion): without a non-vanishing reinjection channel, the relevant epistemic content decays geometrically across session boundaries by theorem, and the sector-persistence template provably does not transfer to the destroy-and-reconstruct regime. CONSORTIA / MEMORATA / durable artifacts are not optional engineering hardening against Cognitive Death — they are the provably-necessary forcing channel through which continuity is imported, the no-go's conditional-positive made operational.
