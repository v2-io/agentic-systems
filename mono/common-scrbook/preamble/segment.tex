...
% \eqtag{Tag-content}
%
% Equation-level tag — emitted by the kramdown converter immediately
% before the equation it labels. Source markdown looks like:
%
%     *[Derived (sector-condition, from prior-slug)]*
%
%     $$ \alpha > \rho/R $$
%
% The kaobook target renders this as a margin annotation; scrbook has no
% Tufte margin column, so we render inline as a small italic standalone
% paragraph leader. It sits directly above the equation, naming what the
% next display object is.
%----------------------------------------------------------------------------
...
% volume — typically references into sibling volumes (e.g., AAD segments
