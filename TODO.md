...
- **Track C body re-authoring** — lead with methodology rather than synthesis-after-convergence. The 2026-05-25 Track C cycle landed the structural OUTLINE move (meta-segments relocated from Appendices §A into a new top-level *Meta-Architecture* section between Part I and Part II per the introduced-before-used discipline). Track C plan §2.b also called for re-authoring each meta-segment's body to lead with the methodology (the recurring meta-pattern shape) rather than with the synthesis-after-convergence framing the segments currently carry. That body-discipline pass is deferred. Plan source: `spikes/meta-segment-narrative-ordering-sweep-plan.md` §2.b. The de-novo-read complaint about *placement* is closed by the 2026-05-25 structural move; the *body register* complaint is what this residual addresses.
