...
> *Developing / not yet ratified.* This is a **narrowing** of the integration-is-replacement "history → Working Notes" rule, captured here durably (alongside D-1/D-2/G3) before any governing-doc surgery so the principle is not lost between sessions. It is **proposal-grade**, not binding; the governing docs (`FORMAT.md`, `doc/spike-routing.md`, `doc/audit-routing-instructions.md`, `spikes/README.md`, the project memories, `CLAUDE.md`) are Joseph-gated and unedited pending his gate. A separate read-and-propose coherence pass (2026-05-31) carries the inventory, the single-source-vs-coherence-edit recommendation, and the WN-follow-up-routing proposal.
