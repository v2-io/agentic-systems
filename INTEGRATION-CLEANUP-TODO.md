...
## Developing discipline — what earns a Working-Note (sharpened 2026-05-31; *pending Joseph's ratification*)

> *Developing / not yet ratified.* This is a **narrowing** of the integration-is-replacement "history → Working Notes" rule, captured here durably (alongside D-1/D-2/G3) before any governing-doc surgery so the principle is not lost between sessions. It is **proposal-grade**, not binding; the governing docs (`FORMAT.md`, `doc/sop/spikes.sop.md`, `doc/audit-routing-instructions.md`, `spikes/README.md`, the project memories, `CLAUDE.md`) are Joseph-gated and unedited pending his gate. The full inventory (file:line drift-flags), the single-source-vs-coherence-edit recommendation with sketched wording, the WN-follow-up-routing proposal, and the two reserved gate-decisions (A-vs-B + project-only-vs-global scope) live in the read-and-propose coherence pass [`msc/wn-discipline-coherence-pass-2026-05-31.md`](msc/wn-discipline-coherence-pass-2026-05-31.md).
