...
ACT formalizes the **adaptive cycle** — one complete traversal of the agent-environment feedback loop — as the fundamental unit of analysis for adaptive, purposeful agents. The theory integrates control theory, causal inference, information theory, and agent architecture to characterize what makes cycles effective, how fast they must run, and when they must change in kind.
