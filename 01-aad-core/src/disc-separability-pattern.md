...
| **Architecture** (#der-directed-separation) | **Class 1 (Separated)** — directed separation holds by construction | **Class 2 (Partial)** — directed separation holds for identified submodules | **Class 3 (Coupled)** — logogenic; needs non-modular coupled formulation (future work) |
