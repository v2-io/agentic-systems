...
- **Landing context.** The segment is the primary result of `spikes/spike-contraction-metric-generalization.md` (2026-04-23 Gap A/B cycle). The Jacobian-level observation (DA2'-inc ≡ (CT2)-M=I) and the (PI)/Čencov observation derive from `spikes/spike-jacobian-b1-strengthening.md` (2026-04-23 follow-up).
