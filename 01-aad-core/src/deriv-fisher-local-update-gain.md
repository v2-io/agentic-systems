...
- **Landing context.** This segment lands from `spikes/.integrated/spike-fisher-local-update-gain-derivation.md` (2026-05-12 audit-strengthening cycle); the spike carries the three-route convergence in expanded form and the boundary-admissibility argument with limit-of-eigenvalues detail.
