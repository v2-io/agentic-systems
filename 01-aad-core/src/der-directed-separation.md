...
- *Composite of Class 1 sub-agents with aligned objectives* (scope route C-i / C-ii / C-iii): Class 1 composite. Within-agent modularity + cross-agent alignment preserve directed separation at the composite level. Standard `#form-composition-closure` applies.
