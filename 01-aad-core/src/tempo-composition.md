...
2. In the ideal case ($\varepsilon^\ast = 0$), every "tick" of an individual's AAD loop contributes directly to the macro AAD loop without friction. Thus $\mathcal T_c = \sum \mathcal T_i$ and $C_{\text{coord}} = 0$.
