...
| A   | Discussion |     | [#separability-pattern](src/separability-pattern.md)                   | Meta-pattern: separable-core / structured-repair / general-open across six ladders (correlation, convention, architecture, contraction, identification, scope); positive-half complement to #identifiability-floor | draft |
| A   | Discussion |     | [#additive-coordinate-forcing](src/additive-coordinate-forcing.md)     | Meta-pattern: AAD forces logarithmic coordinates via Cauchy-FE on AAD-internally-motivated additivity axioms at three layers (chain / divergence / update); anchor-plus-two-theorem structure with Lyapunov and IB Lagrangian as adjacent family members | draft |
