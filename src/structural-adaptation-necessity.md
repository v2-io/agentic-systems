...
- **Grafting**: Incorporating external structure. Transfer learning, acquiring a company, consulting an expert. Query actions (see old-tf-08-exploration-exploitation) are a primary conduit for grafting.
