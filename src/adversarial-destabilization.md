...
- The effects spiral is Boyd's cascading disorientation of the slower adversary, derived here from Lyapunov instability rather than asserted as qualitative military doctrine. Future work should formalize the $\gamma_A(\|\delta_B\|)$ relationship to make the spiral a theorem rather than a discussion-grade observation.
