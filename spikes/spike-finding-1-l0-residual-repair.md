...
**Status:** Spike (proposed segment revision). Promotion-ready replacement for `01-aad-core/src/der-causal-insufficiency-detection.md` addressing Finding 1 of `audits/pending-findings-2026-04-22.md` (L0 residual fails as on-policy detection signal).
