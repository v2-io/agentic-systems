...
**Status**: Working document. First formal sketch of the core novel object in AAT.
**Date**: March 2026
...
*first-principled* — they follow necessarily from AAT's foundations (TFT's
...
This is what makes AAT more than BDI-with-dynamics. BDI says agents have
beliefs and desires but provides no mechanism for desire revision. AAT says:
...
beliefs about strategy" (AAT Part II) is a distinction in *what* is being
updated, not in *how*.
...
**[FIRST-PRINCIPLED — this is AAT's central contribution.]**

The three interactions above constitute the formal content of Boyd's
Orient. This is what TFT was missing and what AAT adds: the cascade from
reality-model update to strategy revision to goal reframing.

TFT formalizes observation → model update (aisthesis → epistrophe). AAT
