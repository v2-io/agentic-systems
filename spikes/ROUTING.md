...
- **Dir-spike batch (§6 lighter gold-gate — read+recommend done, his call):** `class-coercion-wrapping/`, `track-a-intent-dag/`, `track-b-nonlinear-sims/` — verified `integrated-misfiled`, content in canon, no reserved theory decision; a clean/fast yes expected, but his per the gate he set.
...
4. **Cycle-close spike moves still owed (re-verify no orphan content, then `git mv` → `.integrated/`):** `spike-rho-factorization`, `spike-rho-additive-variance-strengthening-2026-04-24` (their CL-2 landing closed 2026-05-18/21 — CHANGELOG), `spike-neutral-drift-endogenous-coupling-strengthening-2026-04-24` (§8/§10.1 were folded into the 2026-05-21 §D.9 integration). (The resolution / triage / rho-recheck feed spikes are already moved.)
