...
1. **Write a segment `gain-sector-bridge.md`** (in `01-aat-core/src/`) that states the conditional derivation: the gain principle + directional fidelity implies the sector condition. Type: `derived`. Status: `conditional` (conditional on B1).
