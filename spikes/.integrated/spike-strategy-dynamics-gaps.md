...
**Status**: Working sketch for the four --GAP-- entries in Section II of `01-aat-core/OUTLINE.md`. These gaps concern how $\Sigma_t$ evolves over time — the dynamics that parallel Section I's treatment of $M_t$ dynamics but with important structural differences.
