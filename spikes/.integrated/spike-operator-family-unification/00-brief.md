...
- **`01-aad-core/src/result-unity-closure-mapping.md` Working Notes** — Koopman/MZ cross-check: the non-degenerate Kalman case exercises the zero-lag memory kernel K₀ with ‖K₀‖ scaling with |ΔK| (update-rule heterogeneity).
