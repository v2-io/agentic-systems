...
**Depends on**: #form-composition-closure, #scope-multi-agent, #deriv-sector-condition, `spikes/spike-composition-bridge-2agent.md`, `msc/working-composition-admissibility.md`
