...
**Status**: Working sketch for the two --GAP-- entries in Section III of `01-aat-core/OUTLINE.md`. These concern how single-agent properties behave under composition — specifically, whether directed separation survives and where adversarial attacks are most effective.
