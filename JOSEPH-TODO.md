...
*Quick nods:* F72 external-eye release · `core.hooksPath` unset · `.claude/` selective un-gitignore · repo-weight untracking (`.archive`/fonts) · CURRENT-VOL1 disposition · Zenodo re-release (defer = default).
