...
**Residual open SP-22 work** = CL-1, CL-2, the `update-operator-sector` tractable landing, and the Joseph-reserved neutral-drift / identifiability-floor present-truth call — all tracked in `msc/spike-routing-2026-05-17.md`. The cluster is no longer "open/bypassed"; it is dispositioned.
