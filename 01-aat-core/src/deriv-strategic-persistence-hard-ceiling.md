...
| Class-level structural cap on gain-decay updates | NeurIPS 2026 Paper 2 §App-D ($\mathcal A_{\text{decay}}$ structural-class theorem) | *downstream sharpening* — lifts this Beta-Bernoulli instance to the gain-decay class; finite-gain mechanisms face bidirectional thresholds |
