...
Before symbiogenesis, the sub-agents were a multi-agent system ( #scope-multi-agent) but not a composite. After, the resulting composite is subject to all of AAD's composition machinery. The symbiogenic transition is the specific dynamical process of composite-agent identity creation.
