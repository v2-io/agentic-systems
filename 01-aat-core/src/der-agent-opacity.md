...
- The emitter-side four-regime classification is a clean dual to `#der-interaction-channel-classification`; its derivation is parallel (boundaries in AAD-native quantities — emitter opacity signal structure, self-model quality, coupling regime).
