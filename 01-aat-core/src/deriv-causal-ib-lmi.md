...
- **2D simulation.** Generalization of `empirica/track-b-nonlinear/variants/variant_causal_ib.py` to 2D with separable drifting/non-drifting subspaces would empirically validate the matrix Lagrangian's directional discrimination. Queued.
