...
- **Trail.** Counterexample arithmetic and the PID citations (marked for relata verification before `claims-verified`): `spikes/.integrated/spike-adaptive-tempo-redundancy-penalty-2026-07-15.md`.
