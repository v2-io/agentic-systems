...
- a *transfer* layer ( #form-composition-closure's tier-specific contraction assumption together with #result-contraction-template's (CC-parallel)/(CC-cascade)/(CC-feedback) closed forms) — *which* Section I/II results lift faithfully, with sharpness depending on the tier of the sub-agents.
