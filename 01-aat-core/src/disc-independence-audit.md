...
- **Acyclicity of $\Sigma_t$** is proved from temporal ordering over a finite horizon ( #deriv-graph-structure-uniqueness). Independent of any independence assumption.
