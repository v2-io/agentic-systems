...
### Causal Structure ( #post-causal-structure) + CIY ( #def-causal-information-yield)
...
### Model ( #form-agent-model) and Sufficiency ( #def-model-sufficiency)
...
*Mapping: approximate. This is where the bandit agent is most deficient relative to AAT-optimal behavior.*
...
### Tempo + Persistence ( #def-adaptive-tempo, #result-persistence-condition)
